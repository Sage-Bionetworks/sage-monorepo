germline_ui <- function(id){
    ...
    shiny::tagList(
      ...
      iatlas.app::textBox(
        ...
        p("To examine the contribution of germline genetic variation to the functional orientation of the immune microenvironment, we conducted heritability analysis, GWAS (N=9,603), and rare variant analysis (N=9,138) across 30 non-hematological cancer types characterized by the TCGA. All analyses adjusted for cancer type, age at diagnosis, sex, and the first seven components from principal component analysis (PCA) done on SNP data, which largely capture genetic ancestry.")
      ),
