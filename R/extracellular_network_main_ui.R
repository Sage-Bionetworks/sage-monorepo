extracellular_network_main_ui <- function(id){
    ...
    shiny::tagList(
        iatlas.app::textBox(
            ...
            shiny::p('This module uses the network of documented ligand-receptor, cell-receptor, and cell-ligand pairs published by ',
                     shiny::a(href = " https://www.nature.com/articles/ncomms8866", "Ramilowski et al., 2015"), " and retrieved from", a(href = "http://fantom.gsc.riken.jp/5/suppl/Ramilowski_et_al_2015/", "FANTOM5."))
