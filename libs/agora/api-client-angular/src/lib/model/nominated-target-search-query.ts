 ...
 */
export interface NominatedTargetSearchQuery {
  /**
   ...
   */
  cohortStudies?: Array<string> | null;
  /**
   * Filter by input data types.
   */
  inputData?: Array<string> | null;
  /**
   ...
   */
  nominatingTeams?: Array<string> | null;
  /**
   * Filter by Pharos class.
   */
  pharosClass?: Array<string> | null;
  /**
   * Filter by programs.
   */
   ...
   */
  sortOrders: Array<NominatedTargetSearchQuery.SortOrdersEnum>;
}
export namespace NominatedTargetSearchQuery {
