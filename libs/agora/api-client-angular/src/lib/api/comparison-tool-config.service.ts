...
// @ts-ignore
import { ComparisonToolConfigPage } from '../model/comparison-tool-config-page';
...
export class ComparisonToolConfigService {
   ...
   */
  public getComparisonToolsConfig(
  ...
  public getComparisonToolsConfig(
    ...
    if (page === null || page === undefined) {
      throw new Error(
        'Required parameter page was null or undefined when calling getComparisonToolsConfig.',
      );
    }
