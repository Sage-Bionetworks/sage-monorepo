    ...
    def make_instance(self, include_optional) -> ChallengeJsonLd:
        ...
        if include_optional:
            return ChallengeJsonLd(
                ...
                status = 'active',
                platform = openchallenges.models.simple_challenge_platform.SimpleChallengePlatform(
                    id = 1, 
                ...
                input_data_types = [
                    openchallenges.models.edam_concept.EdamConcept(
                        id = 1, 
                ...
                starred_count = 100,
                operation = openchallenges.models.edam_concept.EdamConcept(
                    id = 1, 
                    class_id = 'http://edamontology.org/data_0850', 
                    preferred_label = 'Sequence set', ),
