...
class OrganizationsPage(BaseModel):
    ...
    organizations: conlist(Organization) = Field(..., description="A list of organizations")
    __properties = ["number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "organizations"]
