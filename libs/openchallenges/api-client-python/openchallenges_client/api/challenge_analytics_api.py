...
class ChallengeAnalyticsApi(object):
    ...
    @validate_arguments
    def get_challenges_per_year(self, **kwargs) -> ChallengesPerYear:  # noqa: E501
        ...
        >>> thread = api.get_challenges_per_year(async_req=True)
        >>> result = thread.get()
    ...
    def get_challenges_per_year_with_http_info(
        ...
        >>> thread = api.get_challenges_per_year_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ChallengesPerYear, status_code(int), headers(HTTPHeaderDict))
        """
