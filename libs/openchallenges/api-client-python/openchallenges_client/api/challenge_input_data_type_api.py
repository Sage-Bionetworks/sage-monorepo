...
class ChallengeInputDataTypeApi(object):
    ...
    def list_challenge_input_data_types(
        ...
        **kwargs
        ...
        >>> thread = api.list_challenge_input_data_types(challenge_input_data_type_search_query, async_req=True)
        >>> result = thread.get()

        :param challenge_input_data_type_search_query: The search query used to find challenge input data types.
        :type challenge_input_data_type_search_query: ChallengeInputDataTypeSearchQuery
    ...
    def list_challenge_input_data_types_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.list_challenge_input_data_types_with_http_info(challenge_input_data_type_search_query, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ChallengeInputDataTypesPage, status_code(int), headers(HTTPHeaderDict))
        """
