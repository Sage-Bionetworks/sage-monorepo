...
class EdamConceptApi:
    ...
    def list_edam_concepts(
        self,
        edam_concept_search_query: Annotated[Optional[EdamConceptSearchQuery], Field(description="The search query used to find EDAM concepts.")] = None,
