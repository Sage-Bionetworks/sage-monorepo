...
from openchallenges_client.api_response import ApiResponse, T as ApiResponseT
import openchallenges_client.models
from openchallenges_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openchallenges_client.models, klass)
