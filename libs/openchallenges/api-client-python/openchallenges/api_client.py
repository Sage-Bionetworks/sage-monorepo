...
from openchallenges.configuration import Configuration
from openchallenges.api_response import ApiResponse, T as ApiResponseT
import openchallenges.models
from openchallenges import rest
from openchallenges.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openchallenges.models, klass)
