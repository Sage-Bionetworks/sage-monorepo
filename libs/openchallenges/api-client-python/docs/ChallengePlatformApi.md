# openchallenges.ChallengePlatformApi
...
with openchallenges.ApiClient(configuration) as api_client:
    ...
    api_instance = openchallenges.ChallengePlatformApi(api_client)
...
with openchallenges.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openchallenges.ChallengePlatformApi(api_client)
    challenge_platform_search_query = openchallenges.ChallengePlatformSearchQuery() # ChallengePlatformSearchQuery | The search query used to find challenge platforms. (optional)
