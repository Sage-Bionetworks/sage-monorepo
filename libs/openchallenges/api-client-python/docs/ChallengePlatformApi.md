...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------- | --------------------------- |
| [**delete_challenge_platform**](ChallengePlatformApi.md#delete_challenge_platform) | **DELETE** /challengePlatforms/{challengePlatformId} | Delete a challenge platform |
| [**get_challenge_platform**](ChallengePlatformApi.md#get_challenge_platform)       | **GET** /challengePlatforms/{challengePlatformId}    | Get a challenge platform    |
