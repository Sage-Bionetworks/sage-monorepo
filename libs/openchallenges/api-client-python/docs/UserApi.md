# openchallenges_api_client_python.UserApi
...
with openchallenges_api_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = openchallenges_api_client_python.UserApi(api_client)
    user_create_request = openchallenges_api_client_python.UserCreateRequest() # UserCreateRequest | 
