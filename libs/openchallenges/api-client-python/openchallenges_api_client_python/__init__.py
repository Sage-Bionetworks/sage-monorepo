...
if __import__("typing").TYPE_CHECKING:
    ...
    from openchallenges_api_client_python.models.auth_scope import (
        AuthScope as AuthScope,
    )
    from openchallenges_api_client_python.models.basic_error import (
    ...
    from openchallenges_api_client_python.models.image_query import (
    ...
    from openchallenges_api_client_python.models.user_profile import (
