...
class ApiKey(BaseModel):
    ...
    last_used_at: Optional[datetime] = Field(default=None, description="When the API key was last used (null if never used)", alias="lastUsedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "prefix", "createdAt", "expiresAt", "lastUsedAt"]
