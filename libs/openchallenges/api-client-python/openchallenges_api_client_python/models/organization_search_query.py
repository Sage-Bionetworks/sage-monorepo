...
class OrganizationSearchQuery(BaseModel):
    ...
    challenge_contribution_roles: Optional[List[ChallengeContributionRole]] = Field(default=None, description="An array of challenge contribution roles used to filter the results.", alias="challengeContributionRoles")
    ...
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "categories", "challengeContributionRoles", "sort", "direction", "ids", "searchTerms"]
