...
class ChallengeSearchQuery(BaseModel):
    ...
    input_data_types: Optional[List[Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="An array of EDAM concept ID used to filter the results.", alias="inputDataTypes")
    operations: Optional[List[Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="An array of EDAM concept ID used to filter the results.")
