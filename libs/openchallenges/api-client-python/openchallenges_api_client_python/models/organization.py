...
class Organization(BaseModel):
    ...
    challenge_count: Annotated[int, Field(strict=True, ge=0)] = Field(description="The number of challenges involving this organization.", alias="challengeCount")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "login", "description", "avatarKey", "websiteUrl", "challengeCount", "acronym", "createdAt", "updatedAt"]
