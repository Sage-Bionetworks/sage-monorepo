...
class Organization(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="A description of the organization.")
    ...
    challenge_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=0, description="The number of challenges involving this organization.", alias="challengeCount")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "login", "description", "avatarKey", "websiteUrl", "challengeCount", "createdAt", "updatedAt", "acronym"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "challengeCount": obj.get("challengeCount") if obj.get("challengeCount") is not None else 0,
