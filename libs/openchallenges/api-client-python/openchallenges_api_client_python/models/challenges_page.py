...
class ChallengesPage(BaseModel):
    ...
    challenges: List[Challenge] = Field(description="A list of challenges.")
    __properties: ClassVar[List[str]] = ["number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "challenges"]
