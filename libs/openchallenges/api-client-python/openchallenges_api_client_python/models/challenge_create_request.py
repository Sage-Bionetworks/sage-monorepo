...
class ChallengeCreateRequest(BaseModel):
    ...
    description: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1000)]] = Field(default=None, description="The description of the challenge.")
    doi: Optional[Annotated[str, Field(strict=True, max_length=120)]] = Field(default=None, description="The DOI of the challenge.")
    status: ChallengeStatus
    platform_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of a challenge platform.", alias="platformId")
    ...
    submission_types: Optional[List[ChallengeSubmissionType]] = Field(default=None, alias="submissionTypes")
    categories: Optional[List[ChallengeCategory]] = None
    input_data_types: Optional[List[Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, alias="inputDataTypes")
    operation: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The unique identifier of the EDAM concept.")
    __properties: ClassVar[List[str]] = ["slug", "name", "headline", "description", "doi", "status", "platformId", "websiteUrl", "avatarUrl", "startDate", "endDate", "incentives", "submissionTypes", "categories", "inputDataTypes", "operation"]
