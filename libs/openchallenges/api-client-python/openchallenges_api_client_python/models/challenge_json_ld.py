...
class ChallengeJsonLd(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "slug", "name", "headline", "description", "doi", "status", "platform", "websiteUrl", "avatarUrl", "incentives", "submissionTypes", "inputDataTypes", "categories", "startDate", "endDate", "starredCount", "operation", "createdAt", "updatedAt", "@context", "@id", "@type"]
