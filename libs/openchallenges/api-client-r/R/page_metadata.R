  ...
  public = list(
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PageMetadata: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PageMetadata: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PageMetadata: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PageMetadata: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PageMetadata: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for PageMetadata: the required field `hasPrevious` is missing."))
      }
    },
