...
ChallengeInputDataTypesPage <- R6::R6Class(
  ...
  public = list(
    ...
    `_field_list` = c("number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "challengeInputDataTypes"),
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `challengeInputDataTypes`, additional_properties = NULL, ...) {
      if (!missing(`number`)) {
    ...
    toJSON = function() {
      ...
      for (key in names(self$additional_properties)) {
        ChallengeInputDataTypesPageObject[[key]] <- self$additional_properties[[key]]
      }
