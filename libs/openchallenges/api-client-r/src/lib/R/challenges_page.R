...
ChallengesPage <- R6::R6Class(
  ...
  public = list(
    ...
    `hasPrevious` = NULL,
    `challenges` = NULL,
    `_field_list` = c("number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "challenges"),
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `challenges`, additional_properties = NULL, ...) {
      if (!missing(`number`)) {
    ...
    toJSON = function() {
      ...
      for (key in names(self$additional_properties)) {
        ChallengesPageObject[[key]] <- self$additional_properties[[key]]
      }
