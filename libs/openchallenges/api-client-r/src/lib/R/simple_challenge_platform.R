#' Create a new SimpleChallengePlatform
#'
#' @description
...
#' @description SimpleChallengePlatform Class
...
#' @export
SimpleChallengePlatform <- R6::R6Class(
  "SimpleChallengePlatform",
  public = list(
    `id` = NULL,
    `slug` = NULL,
    `name` = NULL,
    `_field_list` = c("id", "slug", "name"),
    `additional_properties` = list(),
    #' Initialize a new SimpleChallengePlatform class.
    #'
    #' @description
    #' Initialize a new SimpleChallengePlatform class.
    #'
    ...
    #' @export
    initialize = function(`id`, `slug`, `name`, additional_properties = NULL, ...) {
      if (!missing(`id`)) {
    ...
    #' To JSON String
    #'
    #' @return SimpleChallengePlatform in JSON format
    #' @export
    toJSON = function() {
      SimpleChallengePlatformObject <- list()
      if (!is.null(self$`id`)) {
        SimpleChallengePlatformObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`slug`)) {
        SimpleChallengePlatformObject[["slug"]] <-
          self$`slug`
      }
      if (!is.null(self$`name`)) {
        SimpleChallengePlatformObject[["name"]] <-
          self$`name`
      }
      for (key in names(self$additional_properties)) {
        SimpleChallengePlatformObject[[key]] <- self$additional_properties[[key]]
      }

      SimpleChallengePlatformObject
    },
    #' Deserialize JSON string into an instance of SimpleChallengePlatform
    #'
    #' @description
    #' Deserialize JSON string into an instance of SimpleChallengePlatform
    #'
    #' @param input_json the JSON input
    #' @return the instance of SimpleChallengePlatform
    #' @export
    ...
    #' Validate JSON input with respect to SimpleChallengePlatform
    #'
    #' @description
    #' Validate JSON input with respect to SimpleChallengePlatform and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimpleChallengePlatform: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`slug`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimpleChallengePlatform: the required field `slug` is missing."))
      }
      ...
      if (!is.null(input_json$`name`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for SimpleChallengePlatform: the required field `name` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of SimpleChallengePlatform
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# SimpleChallengePlatform$unlock()
#
## Below is an example to define the print function
# SimpleChallengePlatform$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# SimpleChallengePlatform$lock()
