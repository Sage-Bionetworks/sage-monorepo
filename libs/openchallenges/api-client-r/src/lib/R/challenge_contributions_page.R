#' Create a new ChallengeContributionsPage
#'
#' @description
#' A page of challenge challenge contributions.
#'
#' @docType class
#' @title ChallengeContributionsPage
#' @description ChallengeContributionsPage Class
...
#' @export
ChallengeContributionsPage <- R6::R6Class(
  ...
  public = list(
    ...
    `_field_list` = c("number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "challengeContributions"),
    `additional_properties` = list(),
    #' Initialize a new ChallengeContributionsPage class.
    #'
    #' @description
    #' Initialize a new ChallengeContributionsPage class.
    #'
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `challengeContributions`, additional_properties = NULL, ...) {
      if (!missing(`number`)) {
    ...
    #' To JSON String
    #'
    #' @return ChallengeContributionsPage in JSON format
    #' @export
    toJSON = function() {
      ChallengeContributionsPageObject <- list()
      if (!is.null(self$`number`)) {
        ChallengeContributionsPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        ChallengeContributionsPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        ChallengeContributionsPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        ChallengeContributionsPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        ChallengeContributionsPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        ChallengeContributionsPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
      if (!is.null(self$`challengeContributions`)) {
        ChallengeContributionsPageObject[["challengeContributions"]] <-
          lapply(self$`challengeContributions`, function(x) x$toJSON())
      }
      for (key in names(self$additional_properties)) {
        ChallengeContributionsPageObject[[key]] <- self$additional_properties[[key]]
      }

      ChallengeContributionsPageObject
    },
    #' Deserialize JSON string into an instance of ChallengeContributionsPage
    #'
    #' @description
    #' Deserialize JSON string into an instance of ChallengeContributionsPage
    #'
    #' @param input_json the JSON input
    #' @return the instance of ChallengeContributionsPage
    #' @export
...
',
    ...
    #' Validate JSON input with respect to ChallengeContributionsPage
    #'
    #' @description
    #' Validate JSON input with respect to ChallengeContributionsPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `hasPrevious` is missing."))
      }
      ...
      if (!is.null(input_json$`challengeContributions`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengeContributionsPage: the required field `challengeContributions` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ChallengeContributionsPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ChallengeContributionsPage$unlock()
#
## Below is an example to define the print function
# ChallengeContributionsPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ChallengeContributionsPage$lock()
