...
UsersPage <- R6::R6Class(
  ...
  public = list(
    ...
    `hasPrevious` = NULL,
    `users` = NULL,
    `_field_list` = c("number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "users"),
    `additional_properties` = list(),
    #' Initialize a new UsersPage class.
    #'
    #' @description
    #' Initialize a new UsersPage class.
    #'
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `users`, additional_properties = NULL, ...) {
      if (!missing(`number`)) {
    ...
    #' To JSON String
    #'
    #' @return UsersPage in JSON format
    #' @export
    toJSON = function() {
      UsersPageObject <- list()
      if (!is.null(self$`number`)) {
        UsersPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        UsersPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        UsersPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        UsersPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        UsersPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        UsersPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
      if (!is.null(self$`users`)) {
        UsersPageObject[["users"]] <-
          lapply(self$`users`, function(x) x$toJSON())
      }
      for (key in names(self$additional_properties)) {
        UsersPageObject[[key]] <- self$additional_properties[[key]]
      }

      UsersPageObject
    },
    #' Deserialize JSON string into an instance of UsersPage
    #'
    #' @description
    #' Deserialize JSON string into an instance of UsersPage
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsersPage
    #' @export
...
',
    ...
    #' Validate JSON input with respect to UsersPage
    #'
    #' @description
    #' Validate JSON input with respect to UsersPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `hasPrevious` is missing."))
      }
      ...
      if (!is.null(input_json$`users`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsersPage: the required field `users` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of UsersPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# UsersPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
