...
import org.sagebionetworks.openchallenges.api.client.model.UserCreateRequest;
import org.sagebionetworks.openchallenges.api.client.model.UserCreateResponse;
import org.sagebionetworks.openchallenges.api.client.model.UsersPage;
...
public class UserApi {
   ...
   */
  private ResponseSpec createUserRequestCreation(
    @jakarta.annotation.Nonnull UserCreateRequest userCreateRequest
  ) throws RestClientResponseException {
    Object postBody = userCreateRequest;
    // verify the required parameter 'userCreateRequest' is set
    if (userCreateRequest == null) {
      throw new RestClientResponseException(
        "Missing the required parameter 'userCreateRequest' when calling createUser",
    ...
    ParameterizedTypeReference<UserCreateResponse> localVarReturnType =
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseEntity<UserCreateResponse> createUserWithHttpInfo(
    @jakarta.annotation.Nonnull UserCreateRequest userCreateRequest
  ) throws RestClientResponseException {
    ParameterizedTypeReference<UserCreateResponse> localVarReturnType =
      new ParameterizedTypeReference<>() {};
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseSpec createUserWithResponseSpec(
    @jakarta.annotation.Nonnull UserCreateRequest userCreateRequest
  ) throws RestClientResponseException {
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  private ResponseSpec deleteUserRequestCreation(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public Object deleteUser(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
    ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<>() {};
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseEntity<Object> deleteUserWithHttpInfo(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
    ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<>() {};
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseSpec deleteUserWithResponseSpec(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  private ResponseSpec getUserRequestCreation(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
    Object postBody = null;
    // verify the required parameter 'userId' is set
    if (userId == null) {
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseEntity<User> getUserWithHttpInfo(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
    ParameterizedTypeReference<User> localVarReturnType = new ParameterizedTypeReference<>() {};
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseSpec getUserWithResponseSpec(@jakarta.annotation.Nonnull Long userId)
    throws RestClientResponseException {
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  private ResponseSpec listUsersRequestCreation(
    @jakarta.annotation.Nullable Integer pageNumber,
    ...
    ParameterizedTypeReference<UsersPage> localVarReturnType =
      new ParameterizedTypeReference<>() {};
    return apiClient.invokeAPI(
      "/users",
      HttpMethod.GET,
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseEntity<UsersPage> listUsersWithHttpInfo(
    @jakarta.annotation.Nullable Integer pageNumber,
    @jakarta.annotation.Nullable Integer pageSize
  ) throws RestClientResponseException {
    ParameterizedTypeReference<UsersPage> localVarReturnType =
   ...
   * @throws RestClientResponseException if an error occurs while attempting to invoke the API
   */
  public ResponseSpec listUsersWithResponseSpec(
    @jakarta.annotation.Nullable Integer pageNumber,
    @jakarta.annotation.Nullable Integer pageSize
  ) throws RestClientResponseException {
