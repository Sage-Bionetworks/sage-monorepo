...
public class ChallengePlatformsPage {
  ...
  public ChallengePlatformsPage challengePlatforms(@jakarta.annotation.Nonnull List<ChallengePlatform> challengePlatforms) {
    
    this.challengePlatforms = challengePlatforms;
    return this;
  }

  public ChallengePlatformsPage addChallengePlatformsItem(ChallengePlatform challengePlatformsItem) {
  ...
  @JsonProperty(JSON_PROPERTY_CHALLENGE_PLATFORMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setChallengePlatforms(@jakarta.annotation.Nonnull List<ChallengePlatform> challengePlatforms) {
    this.challengePlatforms = challengePlatforms;
  }
