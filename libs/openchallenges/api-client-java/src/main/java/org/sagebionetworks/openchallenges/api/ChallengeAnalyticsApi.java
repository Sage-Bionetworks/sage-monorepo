...
import org.openapitools.client.model.ChallengesPerYear;
...
public class ChallengeAnalyticsApi {
    ...
    private ResponseSpec getChallengesPerYearRequestCreation() throws RestClientResponseException {
        ...
        ParameterizedTypeReference<ChallengesPerYear> localVarReturnType = new ParameterizedTypeReference<>() {};
        return apiClient.invokeAPI("/challengeAnalytics/challengesPerYear", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws RestClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<ChallengesPerYear> getChallengesPerYearWithHttpInfo() throws RestClientResponseException {
        ParameterizedTypeReference<ChallengesPerYear> localVarReturnType = new ParameterizedTypeReference<>() {};
