...
public class ChallengesPerYear {
  ...
  public ChallengesPerYear challengeCounts(@jakarta.annotation.Nonnull List<Integer> challengeCounts) {
  ...
  public ChallengesPerYear undatedChallengeCount(@jakarta.annotation.Nonnull Integer undatedChallengeCount) {
