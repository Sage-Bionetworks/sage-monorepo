...
import org.openapitools.client.model.ChallengeDirection;
import org.openapitools.client.model.ChallengeIncentive;
import org.openapitools.client.model.ChallengeSort;
...
public class ChallengeSearchQuery {
  ...
  public ChallengeSearchQuery incentives(@jakarta.annotation.Nullable List<ChallengeIncentive> incentives) {
  ...
  public ChallengeSearchQuery submissionTypes(@jakarta.annotation.Nullable List<ChallengeSubmissionType> submissionTypes) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBMISSION_TYPES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubmissionTypes(@jakarta.annotation.Nullable List<ChallengeSubmissionType> submissionTypes) {
    this.submissionTypes = submissionTypes;
  }

  public ChallengeSearchQuery inputDataTypes(@jakarta.annotation.Nullable List<Long> inputDataTypes) {
  ...
  public ChallengeSearchQuery categories(@jakarta.annotation.Nullable List<ChallengeCategory> categories) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pageNumber, pageSize, sort, hashCodeNullable(sortSeed), hashCodeNullable(direction), incentives, hashCodeNullable(minStartDate), hashCodeNullable(maxStartDate), platforms, organizations, status, submissionTypes, inputDataTypes, operations, categories, searchTerms);
  }
