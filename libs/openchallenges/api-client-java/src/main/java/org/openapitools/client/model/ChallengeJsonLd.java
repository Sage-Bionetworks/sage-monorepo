...
public class ChallengeJsonLd {
  ...
  public ChallengeJsonLd incentives(@jakarta.annotation.Nonnull List<ChallengeIncentive> incentives) {
  ...
  public ChallengeJsonLd submissionTypes(@jakarta.annotation.Nonnull List<ChallengeSubmissionType> submissionTypes) {
  ...
  public ChallengeJsonLd inputDataTypes(@jakarta.annotation.Nullable List<EdamConcept> inputDataTypes) {
  ...
  public ChallengeJsonLd categories(@jakarta.annotation.Nonnull List<ChallengeCategory> categories) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, slug, name, hashCodeNullable(headline), description, hashCodeNullable(doi), status, hashCodeNullable(platform), hashCodeNullable(websiteUrl), hashCodeNullable(avatarUrl), incentives, submissionTypes, inputDataTypes, categories, hashCodeNullable(startDate), hashCodeNullable(endDate), starredCount, hashCodeNullable(operation), createdAt, updatedAt, atContext, atId, atType);
  }
