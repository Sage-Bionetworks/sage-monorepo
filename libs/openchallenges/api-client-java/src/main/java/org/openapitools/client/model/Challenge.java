...
import org.openapitools.client.model.ChallengeCategory;
import org.openapitools.client.model.ChallengeIncentive;
import org.openapitools.client.model.ChallengeStatus;
import org.openapitools.client.model.ChallengeSubmissionType;
import org.openapitools.client.model.EdamConcept;
import org.openapitools.client.model.SimpleChallengePlatform;
...
public class Challenge {
  ...
  @jakarta.annotation.Nullable
  private JsonNullable<SimpleChallengePlatform> platform = JsonNullable.<SimpleChallengePlatform>undefined();
  ...
  public Challenge submissionTypes(@jakarta.annotation.Nonnull List<ChallengeSubmissionType> submissionTypes) {
  ...
  @JsonProperty(JSON_PROPERTY_SUBMISSION_TYPES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSubmissionTypes(@jakarta.annotation.Nonnull List<ChallengeSubmissionType> submissionTypes) {
    this.submissionTypes = submissionTypes;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, slug, name, hashCodeNullable(headline), description, hashCodeNullable(doi), status, hashCodeNullable(platform), hashCodeNullable(websiteUrl), hashCodeNullable(avatarUrl), incentives, submissionTypes, inputDataTypes, categories, hashCodeNullable(startDate), hashCodeNullable(endDate), starredCount, hashCodeNullable(operation), createdAt, updatedAt);
  }
