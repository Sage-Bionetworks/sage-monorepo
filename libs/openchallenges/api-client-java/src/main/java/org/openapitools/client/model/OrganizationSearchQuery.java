...
import org.openapitools.client.model.ChallengeContributionRole;
import org.openapitools.client.model.OrganizationCategory;
import org.openapitools.client.model.OrganizationDirection;
import org.openapitools.client.model.OrganizationSort;
...
public class OrganizationSearchQuery {
  ...
  public static final String JSON_PROPERTY_CHALLENGE_CONTRIBUTION_ROLES = "challengeContributionRoles";
  @jakarta.annotation.Nullable
  ...
  @jakarta.annotation.Nullable
  private JsonNullable<OrganizationDirection> direction = JsonNullable.<OrganizationDirection>undefined();
  ...
  public OrganizationSearchQuery categories(@jakarta.annotation.Nullable List<OrganizationCategory> categories) {
  ...
  public OrganizationSearchQuery challengeContributionRoles(@jakarta.annotation.Nullable List<ChallengeContributionRole> challengeContributionRoles) {
    
    this.challengeContributionRoles = challengeContributionRoles;
    return this;
  }

  public OrganizationSearchQuery addChallengeContributionRolesItem(ChallengeContributionRole challengeContributionRolesItem) {
  ...
  @JsonProperty(JSON_PROPERTY_CHALLENGE_CONTRIBUTION_ROLES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChallengeContributionRoles(@jakarta.annotation.Nullable List<ChallengeContributionRole> challengeContributionRoles) {
    this.challengeContributionRoles = challengeContributionRoles;
  }
  ...
  public OrganizationSearchQuery direction(@jakarta.annotation.Nullable OrganizationDirection direction) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pageNumber, pageSize, categories, challengeContributionRoles, sort, hashCodeNullable(direction), ids, searchTerms);
  }
