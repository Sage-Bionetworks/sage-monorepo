...
import org.openapitools.client.model.ChallengePlatformDirection;
import org.openapitools.client.model.ChallengePlatformSort;
...
public class ChallengePlatformSearchQuery {
  ...
  @jakarta.annotation.Nullable
  private JsonNullable<ChallengePlatformDirection> direction = JsonNullable.<ChallengePlatformDirection>undefined();
  ...
  public ChallengePlatformSearchQuery sort(@jakarta.annotation.Nullable ChallengePlatformSort sort) {
  ...
  public ChallengePlatformSearchQuery direction(@jakarta.annotation.Nullable ChallengePlatformDirection direction) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pageNumber, pageSize, sort, hashCodeNullable(direction), slugs, searchTerms);
  }
