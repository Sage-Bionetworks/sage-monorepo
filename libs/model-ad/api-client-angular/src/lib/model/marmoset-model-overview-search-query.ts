 ...
 */
export interface MarmosetModelOverviewSearchQuery {
  /**
   ...
   */
  sortOrders: Array<MarmosetModelOverviewSearchQuery.SortOrdersEnum>;
}
export namespace MarmosetModelOverviewSearchQuery {
