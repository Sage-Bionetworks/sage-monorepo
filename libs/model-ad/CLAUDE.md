...
| `model-ad-config`                                  | `config/`                                  | Route paths, colors, help URLs, boxplot styles, visualization overview content                                                         |
...
| `model-ad-util`                                    | `util/`                                    | Header and footer navigation links, model organism helpers                                                                             |
