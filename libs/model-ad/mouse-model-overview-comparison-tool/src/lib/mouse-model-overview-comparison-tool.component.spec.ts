...
async function setup() {
  const { fixture } = await render(MouseModelOverviewComparisonToolComponent, {
    ...
    providers: [
      ...
      {
        provide: MouseModelOverviewService,
        useValue: {
          getMouseModelOverviews: jest.fn().mockReturnValue(of([])),
        },
      },
      ...provideComparisonToolService(),
      ...provideComparisonToolFilterService(),
...
describe('MouseModelOverviewComparisonToolComponent', () => {
