...
// @ts-ignore
import { PublicStats } from '../model/public-stats';
// @ts-ignore
...
export class StatsService {
  ...
  ): Observable<HttpResponse<PublicStats>>;
  public getPublicStats(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<PublicStats>>;
  public getPublicStats(
    observe: any = 'body',
    ...
    return this.httpClient.request<PublicStats>(
      'get',
