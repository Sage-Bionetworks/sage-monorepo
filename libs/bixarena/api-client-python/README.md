...
| _BattleApi_        | [**get_battle_effective_categorization**](docs/BattleApi.md#get_battle_effective_categorization)                        | **GET** /battles/{battleId}/categorizations/effective                | Get effective battle categorization                |
...
| _ExamplePromptApi_ | [**get_example_prompt_effective_categorization**](docs/ExamplePromptApi.md#get_example_prompt_effective_categorization) | **GET** /example-prompts/{examplePromptId}/categorizations/effective | Get effective example prompt categorization        |
...
| _ExamplePromptApi_ | [**update_example_prompt**](docs/ExamplePromptApi.md#update_example_prompt)                                             | **PUT** /example-prompts/{examplePromptId}                           | Update an example prompt                           |
