...
class TestExamplePrompt(unittest.TestCase):
    """ExamplePrompt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExamplePrompt:
        """Test ExamplePrompt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExamplePrompt`
        """
        model = ExamplePrompt()
        if include_optional:
