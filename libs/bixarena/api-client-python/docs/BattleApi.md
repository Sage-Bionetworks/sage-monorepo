...
| [**stream_battle_round_completion**](BattleApi.md#stream_battle_round_completion) | **POST** /battles/{battleId}/rounds/{roundId}/stream | Stream a chat completion for a battle round |
...
# **stream_battle_round_completion**

> ModelChatCompletionChunk stream_battle_round_completion(battle_id, round_id, model_id)
...
with bixarena_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Stream a chat completion for a battle round
        api_response = api_instance.stream_battle_round_completion(battle_id, round_id, model_id)
        print("The response of BattleApi->stream_battle_round_completion:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BattleApi->stream_battle_round_completion: %s\n" % e)
```
