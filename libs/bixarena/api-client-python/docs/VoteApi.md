...
with bixarena_api_client.ApiClient(configuration) as api_client:
    ...
    vote_create_request = bixarena_api_client.VoteCreateRequest() # VoteCreateRequest |

    try:
        # Create a vote
        api_response = api_instance.create_vote(vote_create_request)
        print("The response of VoteApi->create_vote:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VoteApi->create_vote: %s\n" % e)
```
...
| ----------------------- | --------------------------------------------- | ----------- | ----- |
| **vote_create_request** | [**VoteCreateRequest**](VoteCreateRequest.md) |             |
