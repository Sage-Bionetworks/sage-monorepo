...
class LeaderboardSearchQuery(BaseModel):
    ...
    page_size: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(default=100, description="The number of items in a single page.", alias="pageSize")
    sort: Optional[LeaderboardSort] = LeaderboardSort.RANK
    direction: Optional[SortDirection] = SortDirection.ASC
    search: Optional[StrictStr] = Field(default=None, description="Search by model name (case-insensitive partial match).")
    license: Optional[License] = None
    organization: Optional[StrictStr] = Field(default=None, description="Filter entries by model organization.")
    snapshot_id: Optional[StrictStr] = Field(default=None, description="Get a specific historical snapshot instead of latest.", alias="snapshotId")
    lookback: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Lookback window in days.")
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "sort", "direction", "search", "license", "organization", "snapshotId", "lookback"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else LeaderboardSort.RANK,
