...
class BattleCreateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "userId", "model1", "model2", "createdAt", "endedAt", "effectiveValidationId", "examplePromptId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "model1": Model.from_dict(obj["model1"]) if obj.get("model1") is not None else None,
            "model2": Model.from_dict(obj["model2"]) if obj.get("model2") is not None else None,
