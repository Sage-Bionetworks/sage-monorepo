...
class ExamplePromptUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    question: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=160)]] = Field(default=None, description="The biomedical question text.")
    source: Optional[ExamplePromptSource] = None
    active: Optional[StrictBool] = Field(default=None, description="Whether this example prompt is currently active/visible for use.")
