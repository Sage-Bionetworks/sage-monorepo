...
class LeaderboardEntryPage(BaseModel):
    ...
    updated_at: datetime = Field(description="When this leaderboard was last updated", alias="updatedAt")
    snapshot_id: StrictStr = Field(description="Identifier for this snapshot/timepoint", alias="snapshotId")
    prior_snapshot_id: Optional[StrictStr] = Field(default=None, description="Snapshot used as the rankDelta baseline. Null when no prior snapshot was found.", alias="priorSnapshotId")
    entry_count: StrictInt = Field(description="Total models in the snapshot.", alias="entryCount")
    vote_count: StrictInt = Field(description="Total evaluations across all models in the snapshot.", alias="voteCount")
    entries: List[LeaderboardEntry] = Field(description="A list of leaderboard entries.")
    __properties: ClassVar[List[str]] = ["number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "updatedAt", "snapshotId", "priorSnapshotId", "entryCount", "voteCount", "entries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.prior_snapshot_id is None and "prior_snapshot_id" in self.model_fields_set:
