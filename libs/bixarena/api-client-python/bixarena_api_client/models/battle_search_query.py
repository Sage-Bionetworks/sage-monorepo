...
class BattleSearchQuery(BaseModel):
    ...
    """ # noqa: E501
    page_number: Annotated[int, Field(strict=True, ge=0)] = Field(description="The page number to return (0-indexed).", alias="pageNumber")
    page_size: Annotated[int, Field(strict=True, ge=1)] = Field(description="The number of items to return in a single page.", alias="pageSize")
    sort: BattleSort
    direction: SortDirection
    user_id: Optional[UUID] = Field(default=None, description="Filter by user ID.", alias="userId")
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "sort", "direction", "userId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else BattleSort.CREATED_AT,
