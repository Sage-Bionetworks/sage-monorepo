...
class LeaderboardSnapshotQuery(BaseModel):
    """
    ...
    sort: Optional[LeaderboardSnapshotSort] = LeaderboardSnapshotSort.CREATED_AT
    direction: Optional[SortDirection] = SortDirection.ASC
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "sort", "direction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else LeaderboardSnapshotSort.CREATED_AT,
