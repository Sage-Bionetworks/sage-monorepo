...
class QuestContributors(BaseModel):
    ...
    total_contributors: StrictInt = Field(description="Total number of unique contributors", alias="totalContributors")
    contributors: List[QuestContributor] = Field(description="Contributors ordered by battle count (descending)")
    __properties: ClassVar[List[str]] = ["questId", "startDate", "endDate", "totalContributors", "contributors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contributors": [QuestContributor.from_dict(_item) for _item in obj["contributors"]] if obj.get("contributors") is not None else None
        })
        return _obj
