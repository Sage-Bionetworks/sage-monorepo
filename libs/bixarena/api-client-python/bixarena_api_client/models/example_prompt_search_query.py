...
class ExamplePromptSearchQuery(BaseModel):
    ...
    active: Optional[StrictBool] = Field(default=None, description="Filter by active status. Ignored for sort=random and sort=usage, which always return only active prompts. ")
    search: Optional[StrictStr] = Field(default=None, description="Search by question content (case-insensitive partial match).")
    categories: Optional[List[BiomedicalCategory]] = Field(default=None, description="Filter by one or more categories. Returns prompts matching any of the given categories.")
    lookback: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Lookback window in days.")
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "sort", "direction", "source", "active", "search", "categories", "lookback"]
