...
class BattleValidationResponse(BaseModel):
    ...
    validated_by: Optional[UUID] = Field(default=None, description="User ID of the validator (null for automated validations)", alias="validatedBy")
    reason: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="Optional reason for the validation decision")
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "battleId", "method", "confidence", "isBiomedical", "validatedBy", "reason", "createdAt"]
