...
class LeaderboardModelHistoryQuery(BaseModel):
    ...
    from_date: Optional[date] = Field(default=None, description="Include only entries created on or after this date.", alias="fromDate")
    to_date: Optional[date] = Field(default=None, description="Include only entries created on or before this date.", alias="toDate")
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "sort", "direction", "fromDate", "toDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else LeaderboardHistorySort.CREATED_AT,
