...
class ExamplePrompt(BaseModel):
    ...
    question: Annotated[str, Field(min_length=1, strict=True, max_length=1000)] = Field(description="The biomedical question text.")
    ...
    __properties: ClassVar[List[str]] = ["id", "question", "source", "active", "createdAt"]
