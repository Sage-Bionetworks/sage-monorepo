...
class ModelSearchQuery(BaseModel):
    ...
    search: Optional[StrictStr] = Field(default=None, description="Search by model name or slug (case-insensitive partial match).")
    active: Optional[StrictBool] = Field(default=None, description="Filter by active status (true returns only active models; false only inactive; omit for all).")
    license: Optional[License] = None
    organization: Optional[StrictStr] = Field(default=None, description="Filter by organization name (case-insensitive partial match).")
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "sort", "direction", "search", "active", "license", "organization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort") if obj.get("sort") is not None else ModelSort.NAME,
