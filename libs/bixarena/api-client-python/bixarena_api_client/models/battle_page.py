...
class BattlePage(BaseModel):
    ...
    battles: List[Battle] = Field(description="List of battles in this page.")
    page: PageMetadata
    __properties: ClassVar[List[str]] = ["battles", "page"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in battles (list)
        _items = []
        if self.battles:
            for _item_battles in self.battles:
                if _item_battles:
                    _items.append(_item_battles.to_dict())
            _dict["battles"] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "battles": [Battle.from_dict(_item) for _item in obj["battles"]]
                if obj.get("battles") is not None
                else None,
                "page": PageMetadata.from_dict(obj["page"])
