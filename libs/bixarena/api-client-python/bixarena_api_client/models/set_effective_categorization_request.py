...
class SetEffectiveCategorizationRequest(BaseModel):
    ...
    """ # noqa: E501
    categorization_id: Optional[UUID] = Field(default=None, description="ID of the categorization row to set as effective. Set to null to clear the effective categorization.", alias="categorizationId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.categorization_id is None and "categorization_id" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categorizationId": obj.get("categorizationId")
        })
        return _obj
