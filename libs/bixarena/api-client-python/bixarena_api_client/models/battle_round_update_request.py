...
class BattleRoundUpdateRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model1Message": MessageCreate.from_dict(obj["model1Message"]) if obj.get("model1Message") is not None else None,
            "model2Message": MessageCreate.from_dict(obj["model2Message"]) if obj.get("model2Message") is not None else None
        })
        return _obj
