...
class BattleCreateRequest(BaseModel):
    ...
    example_prompt_id: Optional[UUID] = Field(default=None, description="ID of the curated example prompt this battle was started from. Omit or pass null for free-form battles.", alias="examplePromptId")
