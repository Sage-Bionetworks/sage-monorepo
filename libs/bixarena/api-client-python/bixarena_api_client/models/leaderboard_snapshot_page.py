...
class LeaderboardSnapshotPage(BaseModel):
    """
    ...
    snapshots: List[LeaderboardSnapshot] = Field(description="A list of leaderboard snapshots.")
    __properties: ClassVar[List[str]] = ["number", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "snapshots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshots": [LeaderboardSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
