...
class ExamplePromptCategorizationCreateRequest(BaseModel):
    """
    Request to manually categorize an example prompt.
    """ # noqa: E501
    category: BiomedicalCategory
    reason: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="Reason for the categorization decision")
