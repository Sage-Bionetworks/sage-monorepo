...
class ExamplePromptPage(BaseModel):
    ...
    example_prompts: List[ExamplePrompt] = Field(
        description="A list of example prompts.", alias="examplePrompts"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "examplePrompts": [
                    ExamplePrompt.from_dict(_item) for _item in obj["examplePrompts"]
                ]
                if obj.get("examplePrompts") is not None
                else None,
            }
        )
        return _obj
