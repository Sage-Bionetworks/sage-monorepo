...
class LeaderboardApi:
    ...
    def get_leaderboard(
        self,
        leaderboard_id: Annotated[StrictStr, Field(description="The unique identifier of a leaderboard")],
        leaderboard_search_query: Annotated[Optional[LeaderboardSearchQuery], Field(description="The search query used to find and filter leaderboard entries.")] = None,
    ...
    def get_leaderboard_snapshots(
        self,
        leaderboard_id: Annotated[StrictStr, Field(description="The unique identifier of a leaderboard")],
        leaderboard_snapshot_query: Annotated[Optional[LeaderboardSnapshotQuery], Field(description="The query used to filter and paginate leaderboard snapshots.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_model_history(
        self,
        leaderboard_id: Annotated[StrictStr, Field(description="The unique identifier of a leaderboard")],
        model_id: Annotated[StrictStr, Field(description="The unique identifier of a model")],
        leaderboard_model_history_query: Annotated[Optional[LeaderboardModelHistoryQuery], Field(description="The query used to filter and paginate historical model performance data.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
