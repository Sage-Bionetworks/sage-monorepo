...
class AuthApi:
    ...
    def login(
        self,
        return_to: Annotated[Optional[Annotated[str, Field(strict=True, max_length=500)]], Field(description="Relative path to redirect to after login (e.g. /battle).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def service_token(
        self,
        audience: Annotated[StrictStr, Field(description="Target audience for the JWT (e.g. 'urn:bixarena:ai')")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def token(
        self,
        audience: Annotated[Optional[StrictStr], Field(description="Target audience for the JWT. If not specified, defaults to urn:bixarena:auth. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
