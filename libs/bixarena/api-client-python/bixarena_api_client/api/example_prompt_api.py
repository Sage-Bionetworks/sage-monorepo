...
class ExamplePromptApi:
    ...
    def create_example_prompt_categorization(
        self,
        example_prompt_id: Annotated[UUID, Field(description="The unique identifier of an example prompt")],
    ...
    def list_example_prompts(
        self,
        example_prompt_search_query: Annotated[Optional[ExamplePromptSearchQuery], Field(description="The search query used to find and filter example prompts.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
