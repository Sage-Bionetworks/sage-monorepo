...
export class DiscussionServicesService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRepoV1ThreadSubmissionSubmissionId(
    submissionId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public getRepoV1ThreadSubmissionSubmissionId(
    ...
    if (submissionId === null || submissionId === undefined) {
      throw new Error(
        'Required parameter submissionId was null or undefined when calling getRepoV1ThreadSubmissionSubmissionId.',
      );
    }
    ...
    let localVarPath = `/repo/v1/thread/submission/${this.configuration.encodeParam({ name: 'submissionId', value: submissionId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
