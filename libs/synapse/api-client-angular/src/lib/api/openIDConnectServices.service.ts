...
export class OpenIDConnectServicesService {
  ...
  public getAuthV1Oauth2AuditGrantedClients(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthOAuthClientAuthorizationHistoryList>(
  ...
  public getAuthV1Oauth2AuditGrantedClientsClientIdTokens(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthOAuthRefreshTokenInformationList>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
  ...
  public getAuthV1Oauth2AuditTokensTokenIdMetadata(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthOAuthRefreshTokenInformation>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
  ...
  public getAuthV1Oauth2Client(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthOAuthClientList>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
  ...
  public getAuthV1Oauth2ClientId(
    ...
    let localVarPath = `/auth/v1/oauth2/client/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthOAuthClient>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
  ...
  public getAuthV1Oauth2Jwks(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthJsonWebKeySet>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
  ...
  public getAuthV1WellKnownOpenidConfiguration(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelOauthOIDConnectConfiguration>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
  ...
  public postAuthV1Oauth2Client(
    ...
    let localVarPath = `/auth/v1/oauth2/client`;
    return this.httpClient.post<OrgSagebionetworksRepoModelOauthOAuthClient>(
      `${this.configuration.basePath}${localVarPath}`,
  ...
  public postAuthV1Oauth2ClientSecretId(
    ...
    return this.httpClient.post<OrgSagebionetworksRepoModelOauthOAuthClientIdAndSecret>(
      `${this.configuration.basePath}${localVarPath}`,
      null,
      {
        context: localVarHttpContext,
  ...
  public postAuthV1Oauth2Consent(
    ...
    return this.httpClient.post<OrgSagebionetworksRepoModelOauthOAuthAuthorizationResponse>(
      `${this.configuration.basePath}${localVarPath}`,
  ...
  public postAuthV1Oauth2Consentcheck(
    ...
    return this.httpClient.post<OrgSagebionetworksRepoModelOauthOAuthConsentGrantedResponse>(
      `${this.configuration.basePath}${localVarPath}`,
      orgSagebionetworksRepoModelOauthOIDCAuthorizationRequest,
      {
        context: localVarHttpContext,
  ...
  public postAuthV1Oauth2Description(
    ...
    return this.httpClient.post<OrgSagebionetworksRepoModelOauthOIDCAuthorizationRequestDescription>(
      `${this.configuration.basePath}${localVarPath}`,
      orgSagebionetworksRepoModelOauthOIDCAuthorizationRequest,
      {
        context: localVarHttpContext,
  ...
  public postAuthV1Oauth2Token(
    ...
    return this.httpClient.post<OrgSagebionetworksRepoModelOauthOIDCTokenResponse>(
      `${this.configuration.basePath}${localVarPath}`,
      null,
      {
        context: localVarHttpContext,
  ...
  public postAuthV1Oauth2Userinfo(
    ...
    let localVarPath = `/auth/v1/oauth2/userinfo`;
    return this.httpClient.post<object>(`${this.configuration.basePath}${localVarPath}`, null, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
  ...
  public putAuthV1Oauth2AuditTokensTokenIdMetadata(
    ...
    let localVarPath = `/auth/v1/oauth2/audit/tokens/${this.configuration.encodeParam({ name: 'tokenId', value: tokenId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}/metadata`;
    return this.httpClient.put<OrgSagebionetworksRepoModelOauthOAuthRefreshTokenInformation>(
      `${this.configuration.basePath}${localVarPath}`,
  ...
  public putAuthV1Oauth2ClientId(
    ...
    let localVarPath = `/auth/v1/oauth2/client/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
    return this.httpClient.put<OrgSagebionetworksRepoModelOauthOAuthClient>(
      `${this.configuration.basePath}${localVarPath}`,
      orgSagebionetworksRepoModelOauthOAuthClient,
      {
        context: localVarHttpContext,
  ...
  public putAuthV1Oauth2ClientIdVerificationPrecheck(
    ...
    return this.httpClient.put<OrgSagebionetworksRepoModelOauthOAuthClientVerificationPrecheckResult>(
      `${this.configuration.basePath}${localVarPath}`,
      orgSagebionetworksRepoModelOauthOAuthClient,
      {
        context: localVarHttpContext,
