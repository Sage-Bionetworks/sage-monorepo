...
export class DataAccessServicesService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRepoV1DataAccessRequestRequestIdPreview(
    requestId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public getRepoV1DataAccessRequestRequestIdPreview(
    ...
    if (requestId === null || requestId === undefined) {
      throw new Error(
        'Required parameter requestId was null or undefined when calling getRepoV1DataAccessRequestRequestIdPreview.',
      );
    }
    ...
    let localVarPath = `/repo/v1/dataAccessRequest/${this.configuration.encodeParam({ name: 'requestId', value: requestId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}/preview`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRepoV1DataAccessRequestRequestIdSignaturePrecheck(
    requestId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public getRepoV1DataAccessRequestRequestIdSignaturePrecheck(
    ...
    if (requestId === null || requestId === undefined) {
      throw new Error(
        'Required parameter requestId was null or undefined when calling getRepoV1DataAccessRequestRequestIdSignaturePrecheck.',
      );
    }
    ...
    let localVarPath = `/repo/v1/dataAccessRequest/${this.configuration.encodeParam({ name: 'requestId', value: requestId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}/signature/precheck`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRepoV1DataAccessRequestRequestIdSignatureQuota(
    requestId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public getRepoV1DataAccessRequestRequestIdSignatureQuota(
    ...
    if (requestId === null || requestId === undefined) {
      throw new Error(
        'Required parameter requestId was null or undefined when calling getRepoV1DataAccessRequestRequestIdSignatureQuota.',
      );
    }
    ...
    let localVarPath = `/repo/v1/dataAccessRequest/${this.configuration.encodeParam({ name: 'requestId', value: requestId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}/signature/quota`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getRepoV1DataAccessSubmissionThreadThreadId(
    threadId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public getRepoV1DataAccessSubmissionThreadThreadId(
    ...
    if (threadId === null || threadId === undefined) {
      throw new Error(
        'Required parameter threadId was null or undefined when calling getRepoV1DataAccessSubmissionThreadThreadId.',
      );
    }
    ...
    let localVarPath = `/repo/v1/dataAccessSubmission/thread/${this.configuration.encodeParam({ name: 'threadId', value: threadId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
    return this.httpClient.request<OrgSagebionetworksRepoModelDataaccessSubmission>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public putRepoV1DataAccessRequestRequestIdSignature(
    requestId: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public putRepoV1DataAccessRequestRequestIdSignature(
    ...
    if (requestId === null || requestId === undefined) {
      throw new Error(
        'Required parameter requestId was null or undefined when calling putRepoV1DataAccessRequestRequestIdSignature.',
      );
    }
