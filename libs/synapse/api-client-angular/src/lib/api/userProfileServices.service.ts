...
// @ts-ignore
import { ListWrapperOfUserProfile } from '../model/listWrapperOfUserProfile';
// @ts-ignore
import { OrgSagebionetworksRepoModelEntityHeader } from '../model/orgSagebionetworksRepoModelEntityHeader';
// @ts-ignore
import { OrgSagebionetworksRepoModelEntityQuerySortDirection } from '../model/orgSagebionetworksRepoModelEntityQuerySortDirection';
// @ts-ignore
import { OrgSagebionetworksRepoModelFavoriteSortBy } from '../model/orgSagebionetworksRepoModelFavoriteSortBy';
// @ts-ignore
import { OrgSagebionetworksRepoModelFavoriteSortDirection } from '../model/orgSagebionetworksRepoModelFavoriteSortDirection';
// @ts-ignore
import { OrgSagebionetworksRepoModelIdList } from '../model/orgSagebionetworksRepoModelIdList';
// @ts-ignore
import { OrgSagebionetworksRepoModelMessageNotificationSettingsSignedToken } from '../model/orgSagebionetworksRepoModelMessageNotificationSettingsSignedToken';
// @ts-ignore
import { OrgSagebionetworksRepoModelPrincipalAliasList } from '../model/orgSagebionetworksRepoModelPrincipalAliasList';
// @ts-ignore
import { OrgSagebionetworksRepoModelPrincipalTypeFilter } from '../model/orgSagebionetworksRepoModelPrincipalTypeFilter';
// @ts-ignore
import { OrgSagebionetworksRepoModelPrincipalUserGroupHeaderResponse } from '../model/orgSagebionetworksRepoModelPrincipalUserGroupHeaderResponse';
// @ts-ignore
import { OrgSagebionetworksRepoModelProjectHeaderList } from '../model/orgSagebionetworksRepoModelProjectHeaderList';
// @ts-ignore
import { OrgSagebionetworksRepoModelProjectListSortColumn } from '../model/orgSagebionetworksRepoModelProjectListSortColumn';
// @ts-ignore
import { OrgSagebionetworksRepoModelProjectListType } from '../model/orgSagebionetworksRepoModelProjectListType';
// @ts-ignore
import { OrgSagebionetworksRepoModelResponseMessage } from '../model/orgSagebionetworksRepoModelResponseMessage';
// @ts-ignore
import { OrgSagebionetworksRepoModelUserBundle } from '../model/orgSagebionetworksRepoModelUserBundle';
// @ts-ignore
import { OrgSagebionetworksRepoModelUserGroupHeaderResponsePage } from '../model/orgSagebionetworksRepoModelUserGroupHeaderResponsePage';
// @ts-ignore
import { OrgSagebionetworksRepoModelUserProfile } from '../model/orgSagebionetworksRepoModelUserProfile';
// @ts-ignore
import { PaginatedResultsOfEntityHeader } from '../model/paginatedResultsOfEntityHeader';
// @ts-ignore
import { PaginatedResultsOfUserProfile } from '../model/paginatedResultsOfUserProfile';
...
export class UserProfileServicesService {
  ...
  public getRepoV1Projects(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelProjectHeaderList>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
  ...
  public getRepoV1User(
    ...
    return this.httpClient.get<PaginatedResultsOfUserProfile>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
  ...
  public getRepoV1UserBundle(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelUserBundle>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
  ...
  public getRepoV1UserGroupHeaders(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelUserGroupHeaderResponsePage>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        params: localVarQueryParameters,
  ...
  public getRepoV1UserProfile(
    ...
    return this.httpClient.get<OrgSagebionetworksRepoModelUserProfile>(
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
        responseType: <any>responseType_,
  ...
  public postRepoV1FavoriteId(
    ...
    let localVarPath = `/repo/v1/favorite/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: undefined })}`;
    return this.httpClient.post<OrgSagebionetworksRepoModelEntityHeader>(
      `${this.configuration.basePath}${localVarPath}`,
      null,
      {
        context: localVarHttpContext,
  ...
  public postRepoV1UserGroupHeadersAliases(
    ...
    return this.httpClient.post<OrgSagebionetworksRepoModelPrincipalUserGroupHeaderResponse>(
      `${this.configuration.basePath}${localVarPath}`,
  ...
  public postRepoV1UserProfile(
    ...
    let localVarPath = `/repo/v1/userProfile`;
    return this.httpClient.post<ListWrapperOfUserProfile>(
      `${this.configuration.basePath}${localVarPath}`,
  ...
  public putRepoV1UserProfile(
    ...
    let localVarPath = `/repo/v1/userProfile`;
    return this.httpClient.put<OrgSagebionetworksRepoModelUserProfile>(
      `${this.configuration.basePath}${localVarPath}`,
