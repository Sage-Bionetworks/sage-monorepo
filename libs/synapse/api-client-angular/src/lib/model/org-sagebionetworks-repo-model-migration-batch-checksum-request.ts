...
export interface OrgSagebionetworksRepoModelMigrationBatchChecksumRequest {
   ...
   */
  migrationType?: OrgSagebionetworksRepoModelMigrationBatchChecksumRequest.MigrationTypeEnum;
  /**
   * Client generated salt to be added to each checksum
   */
  salt?: string;
  /**
   * The minimum ID defining the full range of rows (inclusive).
   */
  minimumId?: number;
  /**
   * The maximum ID defining the full range of rows (inclusive).
   */
  maximumId?: number;
  /**
   * The size of each batch of IDs
   */
  batchSize?: number;
}
