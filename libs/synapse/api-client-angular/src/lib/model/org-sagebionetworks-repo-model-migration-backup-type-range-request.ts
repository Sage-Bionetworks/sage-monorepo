...
export interface OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest {
   ...
   */
  migrationType?: OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest.MigrationTypeEnum;
  /**
   * The value to use as the alias in the XML migration backup file
   */
  aliasType?: OrgSagebionetworksRepoModelMigrationBackupTypeRangeRequest.AliasTypeEnum;
  /**
   * The batch size determines the maxiumum number of rows that will be loaded into memory at one time.
   */
  batchSize?: number;
  /**
