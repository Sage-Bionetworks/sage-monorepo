...
export interface OrgSagebionetworksRepoModelV2WikiV2WikiOrderHint {
  /**
   * The ID of the owner of the wiki page with rootWikiId.
   */
  ownerId?: string;
  /**
   * JSON enum for the types of objects in Synapse.
   */
  ownerObjectType?: OrgSagebionetworksRepoModelV2WikiV2WikiOrderHint.OwnerObjectTypeEnum;
  /**
   * The list of sub wiki ids that in the order that they should be placed relative to their siblings.
   */
  idList?: Array<string>;
  /**
   * The title etag of this object. Should be used to handle concurrently updating wiki order hints (e.g. if the etag of the order hint to update does not match the etag of the associated order hint in the database, reject the update).
   */
  etag?: string;
}
export namespace OrgSagebionetworksRepoModelV2WikiV2WikiOrderHint {
  ...
  export const OwnerObjectTypeEnum = {
    ...
    SearchIndex: 'SEARCH_INDEX' as OwnerObjectTypeEnum,
    SourceDependencyEvent: 'SOURCE_DEPENDENCY_EVENT' as OwnerObjectTypeEnum,
  };
}
