...
export interface OrgSagebionetworksRepoModelMigrationRestoreTypeRequest {
   ...
   */
  migrationType?: OrgSagebionetworksRepoModelMigrationRestoreTypeRequest.MigrationTypeEnum;
  /**
   * The value to use as the alias in the XML migration backup file
   */
  aliasType?: OrgSagebionetworksRepoModelMigrationRestoreTypeRequest.AliasTypeEnum;
  /**
   * S3 key of the backup file to restore.
   */
  ...
  batchSize?: number;
  /**
   * The minimum row ID (inclusive) for the rows contained in this backup.  All rows between the min and max will be deleted before restoring the rows in this request.
   */
  minimumRowId?: number;
  /**
   * The maximum row ID (inclusive) for the rows contained in this backup.  All rows between the min and max will be deleted before restoring the rows in this request.
   */
  maximumRowId?: number;
}
export namespace OrgSagebionetworksRepoModelMigrationRestoreTypeRequest {
  ...
  export const MigrationTypeEnum = {
    ...
    CertifiedUsers: 'CERTIFIED_USERS' as MigrationTypeEnum,
