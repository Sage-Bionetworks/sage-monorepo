...
export interface OrgSagebionetworksRepoModelMessageLocalStackChangeMesssage {
   ...
   */
  objectType?: OrgSagebionetworksRepoModelMessageLocalStackChangeMesssage.ObjectTypeEnum;
  /**
   ...
   */
  changeType?: OrgSagebionetworksRepoModelMessageLocalStackChangeMesssage.ChangeTypeEnum;
  /**
   * The ID of the user who created this change message
   */
  userId?: number;
}
