...
export interface OrgSagebionetworksRepoModelMigrationMigrationTypeCount {
   ...
   */
  type?: OrgSagebionetworksRepoModelMigrationMigrationTypeCount.TypeEnum;
  count?: number;
  maxid?: number;
  minid?: number;
}
export namespace OrgSagebionetworksRepoModelMigrationMigrationTypeCount {
  ...
  export const TypeEnum = {
    ...
    DiscussionThreadSubmissionReference: 'DISCUSSION_THREAD_SUBMISSION_REFERENCE' as TypeEnum,
    ...
    AgentRegistrationActSettings: 'AGENT_REGISTRATION_ACT_SETTINGS' as TypeEnum,
    ...
    FormTemplate: 'FORM_TEMPLATE' as TypeEnum,
    FormTemplateRevision: 'FORM_TEMPLATE_REVISION' as TypeEnum,
