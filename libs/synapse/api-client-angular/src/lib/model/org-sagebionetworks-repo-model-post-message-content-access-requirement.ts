...
export interface OrgSagebionetworksRepoModelPostMessageContentAccessRequirement {
   ...
   */
  accessType?: OrgSagebionetworksRepoModelPostMessageContentAccessRequirement.AccessTypeEnum;
  /**
  ...
  /**
   * The URL of the IFrame to be displayed for the user.  Required when creating or updating.
   */
  url?: string;
}
