...
export const mockComparisonToolDataConfig: ComparisonToolConfig[] = [baseConfig];

export const mockComparisonToolDataConfigWithDropdowns: ComparisonToolConfig[] = [
  { ...baseConfig, dropdowns: ['RNA - Differential Expression', 'Females Only'] },
  { ...baseConfig, dropdowns: ['RNA - Differential Expression', 'Males Only'] },
  { ...baseConfig, dropdowns: ['Protein - Differential Expression', 'SRM'] },
  { ...baseConfig, dropdowns: ['Protein - Differential Expression', 'TMT'] },
  { ...baseConfig, dropdowns: ['Protein - Differential Expression', 'LFQ'] },
];
