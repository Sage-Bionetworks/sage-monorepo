 ...
 * @param matchParentIdSpace true when {@code items} are matched against the parent item filter
 *     rather than the row item filter. Exactly one is matched, never both
 */
