...
import { LocalAuthRequest, LocalAuthResponse } from '../model/models';
...
export class AuthService {
  ...
  public authGoogle(
    ...
    return this.httpClient.get<object>(
      `${this.configuration.basePath}/auth/google`,
      {
  ...
  public authLocal(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpResponse<LocalAuthResponse>>;
  ...
  public authLocal(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpEvent<LocalAuthResponse>>;
  ...
  public authLocal(
    ...
    if (localAuthRequest === null || localAuthRequest === undefined) {
      throw new Error(
        'Required parameter localAuthRequest was null or undefined when calling authLocal.'
      );
    }
    ...
    return this.httpClient.post<LocalAuthResponse>(
      `${this.configuration.basePath}/auth/local`,
      localAuthRequest,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
