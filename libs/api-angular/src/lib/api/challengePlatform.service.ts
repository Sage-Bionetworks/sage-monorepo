...
export class ChallengePlatformService {
  ...
  ): Observable<ChallengePlatformCreateResponse>;
  ...
  public createChallengePlatform(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpResponse<ChallengePlatformCreateResponse>>;
  ...
  public createChallengePlatform(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpEvent<ChallengePlatformCreateResponse>>;
  ...
  public createChallengePlatform(
    ...
    if (
      challengePlatformCreateRequest === null ||
      challengePlatformCreateRequest === undefined
    ) {
      throw new Error(
    ...
    return this.httpClient.post<ChallengePlatformCreateResponse>(
      `${this.configuration.basePath}/challengePlatforms`,
      challengePlatformCreateRequest,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public deleteAllChallengePlatforms(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<object>;
  ...
  public deleteChallengePlatform(
    ...
    return this.httpClient.delete<object>(
      `${this.configuration.basePath}/challengePlatforms/${encodeURIComponent(
        String(challengePlatformId)
      )}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public getChallengePlatform(
    ...
    return this.httpClient.get<ChallengePlatform>(
      `${this.configuration.basePath}/challengePlatforms/${encodeURIComponent(
        String(challengePlatformId)
      )}`,
      {
  ...
  public listChallengePlatforms(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<PageOfChallengePlatforms>;
  ...
  public listChallengePlatforms(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpResponse<PageOfChallengePlatforms>>;
  ...
  public listChallengePlatforms(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' }
  ): Observable<HttpEvent<PageOfChallengePlatforms>>;
  ...
  public listChallengePlatforms(
    ...
    return this.httpClient.get<PageOfChallengePlatforms>(
      `${this.configuration.basePath}/challengePlatforms`,
      {
