#' Create a new ManifestMetadataPage
#'
#' @description
...
#' @description ManifestMetadataPage Class
...
#' @field manifests A list of manifest metadata list(\link{ManifestMetadata})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ManifestMetadataPage <- R6::R6Class(
  ...
  public = list(
    ...
    `hasPrevious` = NULL,
    `manifests` = NULL,
    #' Initialize a new ManifestMetadataPage class.
    #'
    #' @description
    #' Initialize a new ManifestMetadataPage class.
    #'
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `manifests`, ...) {
      if (!missing(`number`)) {
    ...
    #' To JSON String
    #'
    #' @return ManifestMetadataPage in JSON format
    #' @export
    toJSON = function() {
      ManifestMetadataPageObject <- list()
      if (!is.null(self$`number`)) {
        ManifestMetadataPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        ManifestMetadataPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        ManifestMetadataPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        ManifestMetadataPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        ManifestMetadataPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        ManifestMetadataPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
      if (!is.null(self$`manifests`)) {
        ManifestMetadataPageObject[["manifests"]] <-
          lapply(self$`manifests`, function(x) x$toJSON())
      }
      ManifestMetadataPageObject
    },
    #' Deserialize JSON string into an instance of ManifestMetadataPage
    #'
    #' @description
    #' Deserialize JSON string into an instance of ManifestMetadataPage
    #'
    #' @param input_json the JSON input
    #' @return the instance of ManifestMetadataPage
    #' @export
...
',
    ...
    #' Validate JSON input with respect to ManifestMetadataPage
    #'
    #' @description
    #' Validate JSON input with respect to ManifestMetadataPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `hasPrevious` is missing."))
      }
      # check the required field `manifests`
      if (!is.null(input_json$`manifests`)) {
        stopifnot(is.vector(input_json$`manifests`), length(input_json$`manifests`) != 0)
        tmp <- sapply(input_json$`manifests`, function(x) stopifnot(R6::is.R6(x)))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ManifestMetadataPage: the required field `manifests` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ManifestMetadataPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      # check if the required `manifests` is null
      if (is.null(self$`manifests`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `manifests` is null
      if (is.null(self$`manifests`)) {
        invalid_fields["manifests"] <- "Non-nullable required field `manifests` cannot be null."
      }
...
# ManifestMetadataPage$unlock()
#
## Below is an example to define the print function
# ManifestMetadataPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ManifestMetadataPage$lock()
