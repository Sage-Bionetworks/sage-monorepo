#' Create a new OrganizationsPage
#'
#' @description
...
#' @description OrganizationsPage Class
...
OrganizationsPage <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return OrganizationsPage in JSON format
    #' @export
    toJSON = function() {
      OrganizationsPageObject <- list()
      if (!is.null(self$`number`)) {
        OrganizationsPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        OrganizationsPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        OrganizationsPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        OrganizationsPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        OrganizationsPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        OrganizationsPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
    ...
    #' @return the instance of OrganizationsPage
    #' @export
...
',
    ...
    #'
    #' @description
    #' Validate JSON input with respect to OrganizationsPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `hasPrevious` is missing."))
      }
      ...
      if (!is.null(input_json$`organizations`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for OrganizationsPage: the required field `organizations` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of OrganizationsPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# OrganizationsPage$unlock()
#
## Below is an example to define the print function
# OrganizationsPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# OrganizationsPage$lock()
