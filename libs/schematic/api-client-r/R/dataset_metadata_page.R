#' Create a new DatasetMetadataPage
#'
#' @description
#' A page of dataset metadata.
#'
#' @docType class
#' @title DatasetMetadataPage
#' @description DatasetMetadataPage Class
...
#' @field datasets An array of dataset meatdata. list(\link{DatasetMetadata})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
DatasetMetadataPage <- R6::R6Class(
  "DatasetMetadataPage",
  public = list(
    `number` = NULL,
    `size` = NULL,
    ...
    `hasPrevious` = NULL,
    `datasets` = NULL,
    #' Initialize a new DatasetMetadataPage class.
    #'
    #' @description
    #' Initialize a new DatasetMetadataPage class.
    #'
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `datasets`, ...) {
      if (!missing(`number`)) {
    ...
    #' To JSON String
    #'
    #' @return DatasetMetadataPage in JSON format
    #' @export
    toJSON = function() {
      DatasetMetadataPageObject <- list()
      if (!is.null(self$`number`)) {
        DatasetMetadataPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        DatasetMetadataPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        DatasetMetadataPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        DatasetMetadataPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        DatasetMetadataPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        DatasetMetadataPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
      if (!is.null(self$`datasets`)) {
        DatasetMetadataPageObject[["datasets"]] <-
          lapply(self$`datasets`, function(x) x$toJSON())
      }
      DatasetMetadataPageObject
    },
    #' Deserialize JSON string into an instance of DatasetMetadataPage
    #'
    #' @description
    #' Deserialize JSON string into an instance of DatasetMetadataPage
    #'
    #' @param input_json the JSON input
    #' @return the instance of DatasetMetadataPage
    #' @export
...
',
    ...
    #' Validate JSON input with respect to DatasetMetadataPage
    #'
    #' @description
    #' Validate JSON input with respect to DatasetMetadataPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `hasPrevious` is missing."))
      }
      # check the required field `datasets`
      if (!is.null(input_json$`datasets`)) {
        stopifnot(is.vector(input_json$`datasets`), length(input_json$`datasets`) != 0)
        tmp <- sapply(input_json$`datasets`, function(x) stopifnot(R6::is.R6(x)))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for DatasetMetadataPage: the required field `datasets` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of DatasetMetadataPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      # check if the required `datasets` is null
      if (is.null(self$`datasets`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `datasets` is null
      if (is.null(self$`datasets`)) {
        invalid_fields["datasets"] <- "Non-nullable required field `datasets` cannot be null."
      }
...
# DatasetMetadataPage$unlock()
#
## Below is an example to define the print function
# DatasetMetadataPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DatasetMetadataPage$lock()
