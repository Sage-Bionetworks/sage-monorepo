#' Create a new ProjectMetadataPage
#'
#' @description
...
#' @description ProjectMetadataPage Class
...
#' @field projects An array of project metadata. list(\link{ProjectMetadata})
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
ProjectMetadataPage <- R6::R6Class(
  "ProjectMetadataPage",
  public = list(
    `number` = NULL,
    `size` = NULL,
    ...
    `hasPrevious` = NULL,
    `projects` = NULL,
    #' Initialize a new ProjectMetadataPage class.
    #'
    #' @description
    #' Initialize a new ProjectMetadataPage class.
    #'
    ...
    #' @export
    initialize = function(`number`, `size`, `totalElements`, `totalPages`, `hasNext`, `hasPrevious`, `projects`, ...) {
      if (!missing(`number`)) {
    ...
    #' To JSON String
    #'
    #' @return ProjectMetadataPage in JSON format
    #' @export
    toJSON = function() {
      ProjectMetadataPageObject <- list()
      if (!is.null(self$`number`)) {
        ProjectMetadataPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        ProjectMetadataPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        ProjectMetadataPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        ProjectMetadataPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        ProjectMetadataPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        ProjectMetadataPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
      if (!is.null(self$`projects`)) {
        ProjectMetadataPageObject[["projects"]] <-
          lapply(self$`projects`, function(x) x$toJSON())
      }
      ProjectMetadataPageObject
    },
    #' Deserialize JSON string into an instance of ProjectMetadataPage
    #'
    #' @description
    #' Deserialize JSON string into an instance of ProjectMetadataPage
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProjectMetadataPage
    #' @export
...
',
    ...
    #' Validate JSON input with respect to ProjectMetadataPage
    #'
    #' @description
    #' Validate JSON input with respect to ProjectMetadataPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `hasPrevious` is missing."))
      }
      # check the required field `projects`
      if (!is.null(input_json$`projects`)) {
        stopifnot(is.vector(input_json$`projects`), length(input_json$`projects`) != 0)
        tmp <- sapply(input_json$`projects`, function(x) stopifnot(R6::is.R6(x)))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ProjectMetadataPage: the required field `projects` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ProjectMetadataPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
    ...
    isValid = function() {
      ...
      # check if the required `projects` is null
      if (is.null(self$`projects`)) {
        return(FALSE)
      }
    ...
    getInvalidFields = function() {
      ...
      # check if the required `projects` is null
      if (is.null(self$`projects`)) {
        invalid_fields["projects"] <- "Non-nullable required field `projects` cannot be null."
      }
...
# ProjectMetadataPage$unlock()
#
## Below is an example to define the print function
# ProjectMetadataPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProjectMetadataPage$lock()
