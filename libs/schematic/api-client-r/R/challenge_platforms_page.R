#' Create a new ChallengePlatformsPage
#'
#' @description
#' A page of challenge platforms.
#'
#' @docType class
#' @title ChallengePlatformsPage
#' @description ChallengePlatformsPage Class
...
#' @export
ChallengePlatformsPage <- R6::R6Class(
  ...
  public = list(
    ...
    #' To JSON String
    #'
    #' @return ChallengePlatformsPage in JSON format
    #' @export
    toJSON = function() {
      ChallengePlatformsPageObject <- list()
      if (!is.null(self$`number`)) {
        ChallengePlatformsPageObject[["number"]] <-
          self$`number`
      }
      if (!is.null(self$`size`)) {
        ChallengePlatformsPageObject[["size"]] <-
          self$`size`
      }
      if (!is.null(self$`totalElements`)) {
        ChallengePlatformsPageObject[["totalElements"]] <-
          self$`totalElements`
      }
      if (!is.null(self$`totalPages`)) {
        ChallengePlatformsPageObject[["totalPages"]] <-
          self$`totalPages`
      }
      if (!is.null(self$`hasNext`)) {
        ChallengePlatformsPageObject[["hasNext"]] <-
          self$`hasNext`
      }
      if (!is.null(self$`hasPrevious`)) {
        ChallengePlatformsPageObject[["hasPrevious"]] <-
          self$`hasPrevious`
      }
    ...
    #' @return the instance of ChallengePlatformsPage
    #' @export
...
',
    ...
    #'
    #' @description
    #' Validate JSON input with respect to ChallengePlatformsPage and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`number`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `number` is missing."))
      }
      ...
      if (!is.null(input_json$`size`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `size` is missing."))
      }
      ...
      if (!is.null(input_json$`totalElements`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `totalElements` is missing."))
      }
      ...
      if (!is.null(input_json$`totalPages`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `totalPages` is missing."))
      }
      ...
      if (!is.null(input_json$`hasNext`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `hasNext` is missing."))
      }
      ...
      if (!is.null(input_json$`hasPrevious`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `hasPrevious` is missing."))
      }
      ...
      if (!is.null(input_json$`challengePlatforms`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ChallengePlatformsPage: the required field `challengePlatforms` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ChallengePlatformsPage
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ChallengePlatformsPage$unlock()
#
## Below is an example to define the print function
# ChallengePlatformsPage$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ChallengePlatformsPage$lock()
