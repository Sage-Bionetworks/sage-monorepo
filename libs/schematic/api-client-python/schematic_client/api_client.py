...
from schematic_client import rest
from schematic_client.configuration import Configuration
from schematic_client.exceptions import ApiTypeError, ApiValueError, ApiException
from schematic_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = StorageApi()
        api_instance.list_storage_project_datasets  # this is an instance of the class Endpoint
        api_instance.list_storage_project_datasets()  # this invokes api_instance.list_storage_project_datasets.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.list_storage_project_datasets.callable or self.callable in this class
