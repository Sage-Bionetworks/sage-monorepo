...
| ---------------------------------------------------------- | ---------------------------------------- | -------- | ------------------------------------------- | ---------- |
| [0001](./0001-bixarena-leaderboard-snapshot-automation.md) | BixArena Leaderboard Snapshot Automation | Approved | [tschaffter](https://github.com/tschaffter) | 2026-01-09 |
