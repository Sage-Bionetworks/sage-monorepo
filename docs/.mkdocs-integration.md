...
The `docs/rfcs/` directory is **NOT** included in the MkDocs site. RFCs are proposals under review and should be reviewed via GitHub PRs. Once approved, they move to `docs/architecture/` and become visible on the site.
