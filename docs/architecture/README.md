...
| [BixArena Leaderboard Snapshot Automation](./bixarena-leaderboard-snapshot-automation-plan.md) | Active      | 2026-01-09 | Automated daily leaderboard snapshot generation via ECS Scheduled Fargate Task |
