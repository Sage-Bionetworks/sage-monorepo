...
test.describe('mouse model details', () => {
...
test.describe('mouse model details - omics', () => {
...
test.describe('mouse model details - resources', () => {
...
test.describe('mouse model details - model with special characters', () => {
...
test.describe('mouse model details - boxplots selector - table of contents', () => {
  ...
  test('clicking on table of contents link scrolls to appropriate section', async ({ page }) => {
    await expectTocLinksScrollToSections(page, '/models/3xTg-AD/biomarkers?modelOrganism=mouse', 2);
  });
...
test.describe('mouse model details - boxplots selector - share links - initial load', () => {
...
test.describe('mouse model details - boxplots selector - share links - same-document navigation', () => {
...
test.describe('mouse model details - boxplots selector - share links - updates', () => {
  const basePath = '/models/Abca7*V1599M/biomarkers?modelOrganism=mouse';
  const tissueDefault = 'Cerebral Cortex';
...
test.describe('mouse model details - boxplots selector - share links - link button', () => {
  const basePath = '/models/Abca7*V1599M/biomarkers?modelOrganism=mouse';
