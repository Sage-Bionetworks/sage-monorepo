...
class TranscriptomicsIndividualMapperTest {
  ...
  void shouldMapDocumentToDtoWithAllFields() {
    // given
    TranscriptomicsIndividualDocument document = new TranscriptomicsIndividualDocument();
    ...
    // when
    TranscriptomicsIndividualDto dto = mapper.toDto(document);
  ...
  void shouldReturnNullWhenDocumentIsNull() {
    // given / when
    TranscriptomicsIndividualDto dto = mapper.toDto(null);
