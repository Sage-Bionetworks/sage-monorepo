...
@Schema(name = "ProteomicsSearchQuery", description = "Proteomics search query with pagination and filtering options.")
@JsonTypeName("ProteomicsSearchQuery")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.14.0")
public class ProteomicsSearchQueryDto {
  ...
  public ProteomicsSearchQueryDto() {
    super();
  }
   ...
   */
  public ProteomicsSearchQueryDto(List<String> categories, List<String> sortFields, List<SortOrdersEnum> sortOrders) {
    this.categories = categories;
    this.sortFields = sortFields;
    this.sortOrders = sortOrders;
  }

  public ProteomicsSearchQueryDto pageNumber(Integer pageNumber) {
  ...
  public ProteomicsSearchQueryDto pageSize(Integer pageSize) {
  ...
  public ProteomicsSearchQueryDto addCategoriesItem(String categoriesItem) {
  ...
  @Schema(name = "categories", example = "[\"PROTEIN - DIFFERENTIAL EXPRESSION\",\"Tissue - Hemibrain\"]", description = "Array of category values from the dropdown selections. The API will parse these to extract the tissue information. Expected format: [mainCategory, tissueCategory] ", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ProteomicsSearchQueryDto items(@Nullable List<String> items) {
    this.items = items;
    return this;
  }

  public ProteomicsSearchQueryDto addItemsItem(String itemsItem) {
    if (this.items == null) {
  ...
  @Schema(name = "items", example = "[\"ENSMUSG11111111110P11110~LOAD2~Female\",\"ENSMUSG11111111111P11111~LOAD1~Male\"]", description = "List of composite identifiers to filter by. Each identifier uses the format \"unique_id~name~sex\" where each identifier represents one complete combination of unique ID, gene name, and sex.  Example: \"ENSMUSG11111111110P11110~LOAD2~Female\" filters for documents matching that exact unique ID, name, and sex. Multiple items can be provided to filter for multiple specific combinations. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("items")
  ...
  public ProteomicsSearchQueryDto itemFilterType(ItemFilterTypeQueryDto itemFilterType) {
  ...
  public ProteomicsSearchQueryDto biodomains(@Nullable List<String> biodomains) {
    this.biodomains = biodomains;
    return this;
  }

  public ProteomicsSearchQueryDto addBiodomainsItem(String biodomainsItem) {
  ...
  public ProteomicsSearchQueryDto modelType(@Nullable List<String> modelType) {
    this.modelType = modelType;
    return this;
  }

  public ProteomicsSearchQueryDto addModelTypeItem(String modelTypeItem) {
  ...
  public ProteomicsSearchQueryDto name(@Nullable List<String> name) {
    this.name = name;
    return this;
  }

  public ProteomicsSearchQueryDto addNameItem(String nameItem) {
    if (this.name == null) {
  ...
  public ProteomicsSearchQueryDto sex(@Nullable List<String> sex) {
    this.sex = sex;
    return this;
  }

  public ProteomicsSearchQueryDto addSexItem(String sexItem) {
    if (this.sex == null) {
  ...
  public ProteomicsSearchQueryDto sortFields(List<String> sortFields) {
    this.sortFields = sortFields;
    return this;
  }

  public ProteomicsSearchQueryDto addSortFieldsItem(String sortFieldsItem) {
   ...
   */
  @NotNull @Size(min = 1) 
  @Schema(name = "sortFields", example = "[\"display_symbol\",\"name\"]", description = "List of field names to sort by (e.g., \"display_symbol,name\"). Each field in sortFields must have a corresponding order in sortOrders. ", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ProteomicsSearchQueryDto sortOrders(List<SortOrdersEnum> sortOrders) {
    this.sortOrders = sortOrders;
    return this;
  }

  public ProteomicsSearchQueryDto addSortOrdersItem(SortOrdersEnum sortOrdersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pageNumber, proteomicsSearchQuery.pageNumber) &&
        ...
        Objects.equals(this.name, proteomicsSearchQuery.name) &&
        Objects.equals(this.sex, proteomicsSearchQuery.sex) &&
        Objects.equals(this.sortFields, proteomicsSearchQuery.sortFields) &&
        Objects.equals(this.sortOrders, proteomicsSearchQuery.sortOrders);
  }
  ...
  public static class Builder {
    ...
    private ProteomicsSearchQueryDto instance;

    public Builder() {
      this(new ProteomicsSearchQueryDto());
    }

    protected Builder(ProteomicsSearchQueryDto instance) {
    ...
    public ProteomicsSearchQueryDto.Builder pageNumber(Integer pageNumber) {
    ...
    public ProteomicsSearchQueryDto.Builder categories(List<String> categories) {
      this.instance.categories(categories);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder items(List<String> items) {
    ...
    public ProteomicsSearchQueryDto.Builder search(String search) {
      this.instance.search(search);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder biodomains(List<String> biodomains) {
      this.instance.biodomains(biodomains);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder modelType(List<String> modelType) {
      this.instance.modelType(modelType);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder name(List<String> name) {
      this.instance.name(name);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder sex(List<String> sex) {
      this.instance.sex(sex);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder sortFields(List<String> sortFields) {
      this.instance.sortFields(sortFields);
      return this;
    }
    
    public ProteomicsSearchQueryDto.Builder sortOrders(List<SortOrdersEnum> sortOrders) {
      this.instance.sortOrders(sortOrders);
      return this;
    }
    
    /**
    * returns a built ProteomicsSearchQueryDto instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public ProteomicsSearchQueryDto build() {
      try {
  ...
  */
  public static ProteomicsSearchQueryDto.Builder builder() {
    return new ProteomicsSearchQueryDto.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public ProteomicsSearchQueryDto.Builder toBuilder() {
    ProteomicsSearchQueryDto.Builder builder = new ProteomicsSearchQueryDto.Builder();
