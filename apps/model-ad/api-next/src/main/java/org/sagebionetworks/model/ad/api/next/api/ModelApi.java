...
public interface ModelApi {
    ...
    @Operation(
        ...
        description = "Retrieve detailed information for a specific model by its name and model organism type.",
        tags = { "Model" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/models/{modelOrganism}/{name}",
        produces = { "application/json", "application/problem+json" }
    )
    
    default ResponseEntity<ModelDto> getModelByName(
        @Parameter(name = "modelOrganism", description = "The type of model organism (e.g., mouse, marmoset)", required = true, in = ParameterIn.PATH) @PathVariable("modelOrganism") ModelOrganismDto modelOrganism,
        ...
        return getDelegate().getModelByName(modelOrganism, name);
    }
