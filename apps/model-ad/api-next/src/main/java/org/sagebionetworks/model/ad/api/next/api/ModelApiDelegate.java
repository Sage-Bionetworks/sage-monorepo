...
public interface ModelApiDelegate {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"genetic_info\" : [ { \"modified_gene\" : \"modified_gene\", \"ensembl_gene_id\" : \"ensembl_gene_id\", \"allele\" : \"allele\", \"mgi_allele_id\" : 6.027456183070403, \"allele_type\" : \"allele_type\" }, { \"modified_gene\" : \"modified_gene\", \"ensembl_gene_id\" : \"ensembl_gene_id\", \"allele\" : \"allele\", \"mgi_allele_id\" : 6.027456183070403, \"allele_type\" : \"allele_type\" } ], \"aliases\" : [ \"aliases\", \"aliases\" ], \"pathology\" : [ { \"evidence_type\" : \"evidence_type\", \"data\" : [ { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" }, { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" } ], \"name\" : \"name\", \"tissue\" : \"tissue\", \"units\" : \"units\", \"age\" : \"age\" }, { \"evidence_type\" : \"evidence_type\", \"data\" : [ { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" }, { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" } ], \"name\" : \"name\", \"tissue\" : \"tissue\", \"units\" : \"units\", \"age\" : \"age\" } ], \"contributing_group\" : \"contributing_group\", \"biomarkers\" : [ { \"evidence_type\" : \"evidence_type\", \"data\" : [ { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" }, { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" } ], \"name\" : \"name\", \"tissue\" : \"tissue\", \"units\" : \"units\", \"age\" : \"age\" }, { \"evidence_type\" : \"evidence_type\", \"data\" : [ { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" }, { \"sex\" : \"Female\", \"value\" : 1.4658129805029452, \"genotype\" : \"genotype\", \"individual_id\" : \"individual_id\" } ], \"name\" : \"name\", \"tissue\" : \"tissue\", \"units\" : \"units\", \"age\" : \"age\" } ], \"gene_expression\" : \"gene_expression\", \"disease_correlation\" : \"disease_correlation\", \"matched_controls\" : [ \"matched_controls\", \"matched_controls\" ], \"model_type\" : \"model_type\", \"jax_id\" : 0.8008281904610115, \"rrid\" : \"rrid\", \"genotype\" : \"genotype\", \"spatial_transcriptomics\" : \"spatial_transcriptomics\", \"alzforum_id\" : \"alzforum_id\", \"study_synid\" : \"study_synid\", \"name\" : \"name\" }";
     ...
     *         or Invalid request (status code 400)
     *         or The request cannot be fulfilled due to an unexpected server error (status code 500)
     * @see ModelApi#searchModels
     */
    default ResponseEntity<List<SearchResultDto>> searchModels(String q) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"id\" : \"id\", \"match_value\" : \"match_value\", \"match_field\" : \"match_field\" }, { \"id\" : \"id\", \"match_value\" : \"match_value\", \"match_field\" : \"match_field\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/problem+json"))) {
