...
public class GeneExpressionSearchQueryDto {
  ...
  @Schema(
    name = "items",
    example = "[\"ENSMUSG00000000001~Gnai3\",\"ENSMUSG00000000028~Cdc45\",\"ENSMUSG00000000037~Scml2\"]",
  ...
  public GeneExpressionSearchQueryDto sortFields(@Nullable String sortFields) {
  ...
  public GeneExpressionSearchQueryDto sortOrders(@Nullable String sortOrders) {
