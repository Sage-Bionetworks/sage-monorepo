...
@Schema(name = "Transcriptomics", description = "Transcriptomics")
@JsonTypeName("Transcriptomics")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.14.0")
public class TranscriptomicsDto {
  ...
  public TranscriptomicsDto ensemblGeneId(String ensemblGeneId) {
    this.ensemblGeneId = ensemblGeneId;
    return this;
  }
  ...
  public TranscriptomicsDto geneSymbol(String geneSymbol) {
    this.geneSymbol = geneSymbol;
    return this;
  }
  ...
  public TranscriptomicsDto biodomains(List<String> biodomains) {
    this.biodomains = biodomains;
    return this;
  }

  public TranscriptomicsDto addBiodomainsItem(String biodomainsItem) {
  ...
  public TranscriptomicsDto matchedControl(String matchedControl) {
    this.matchedControl = matchedControl;
    return this;
  }
  ...
  public TranscriptomicsDto modelGroup(String modelGroup) {
    this.modelGroup = modelGroup;
    return this;
  }
  ...
  public TranscriptomicsDto modelType(String modelType) {
    this.modelType = modelType;
    return this;
  }
  ...
  public TranscriptomicsDto tissue(String tissue) {
    this.tissue = tissue;
    return this;
  }
  ...
  public TranscriptomicsDto _12months(@Nullable FoldChangeResultDto _12months) {
  ...
  public TranscriptomicsDto _18months(@Nullable FoldChangeResultDto _18months) {
  ...
  public boolean equals(Object o) {
    ...
    TranscriptomicsDto transcriptomics = (TranscriptomicsDto) o;
    return Objects.equals(this.compositeId, transcriptomics.compositeId) &&
        Objects.equals(this.ensemblGeneId, transcriptomics.ensemblGeneId) &&
        Objects.equals(this.geneSymbol, transcriptomics.geneSymbol) &&
        Objects.equals(this.biodomains, transcriptomics.biodomains) &&
        Objects.equals(this.name, transcriptomics.name) &&
        Objects.equals(this.matchedControl, transcriptomics.matchedControl) &&
  ...
  public String toString() {
    ...
    sb.append("class TranscriptomicsDto {\n");
  ...
  public static class Builder {
    ...
    private TranscriptomicsDto instance;

    public Builder() {
      this(new TranscriptomicsDto());
    }

    protected Builder(TranscriptomicsDto instance) {
      this.instance = instance;
    }

    protected Builder copyOf(TranscriptomicsDto value) { 
    ...
    public TranscriptomicsDto.Builder compositeId(String compositeId) {
      this.instance.compositeId(compositeId);
      return this;
    }
    
    public TranscriptomicsDto.Builder ensemblGeneId(String ensemblGeneId) {
      this.instance.ensemblGeneId(ensemblGeneId);
      return this;
    }
    
    public TranscriptomicsDto.Builder geneSymbol(String geneSymbol) {
      this.instance.geneSymbol(geneSymbol);
      return this;
    }
    
    public TranscriptomicsDto.Builder biodomains(List<String> biodomains) {
    ...
    public TranscriptomicsDto.Builder matchedControl(String matchedControl) {
      this.instance.matchedControl(matchedControl);
      return this;
    }
    
    public TranscriptomicsDto.Builder modelGroup(String modelGroup) {
      this.instance.modelGroup(modelGroup);
      return this;
    }
    
    public TranscriptomicsDto.Builder modelType(String modelType) {
      this.instance.modelType(modelType);
      return this;
    }
    
    public TranscriptomicsDto.Builder tissue(String tissue) {
    ...
    public TranscriptomicsDto.Builder _4months(FoldChangeResultDto _4months) {
      this.instance._4months(_4months);
      return this;
    }
    
    public TranscriptomicsDto.Builder _12months(FoldChangeResultDto _12months) {
    ...
    /**
    * returns a built TranscriptomicsDto instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public TranscriptomicsDto build() {
      try {
  ...
  */
  public static TranscriptomicsDto.Builder builder() {
    return new TranscriptomicsDto.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public TranscriptomicsDto.Builder toBuilder() {
    TranscriptomicsDto.Builder builder = new TranscriptomicsDto.Builder();
