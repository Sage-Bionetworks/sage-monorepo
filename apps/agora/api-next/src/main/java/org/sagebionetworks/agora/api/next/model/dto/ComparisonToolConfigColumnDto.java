...
public class ComparisonToolConfigColumnDto {
  ...
  /**
   * The data type of the column. Must be 'text', 'heat_map', 'link_internal', 'link_external', 'primary', or 'numeric', where 'primary' is the primary key column that uniquely identifies each record in the table.
   */
   ...
   */
  @NotNull 
  @Schema(name = "type", description = "The data type of the column. Must be 'text', 'heat_map', 'link_internal', 'link_external', 'primary', or 'numeric', where 'primary' is the primary key column that uniquely identifies each record in the table.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("type")
