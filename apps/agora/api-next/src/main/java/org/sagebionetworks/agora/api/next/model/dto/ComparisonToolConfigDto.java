...
import org.sagebionetworks.agora.api.next.model.dto.ComparisonToolConfigFilterDto;
...
public class ComparisonToolConfigDto {
  ...
  private ComparisonToolConfigPageDto page;
   ...
   */
  public ComparisonToolConfigDto(ComparisonToolConfigPageDto page, List<String> dropdowns, String rowCount, List<@Valid ComparisonToolConfigColumnDto> columns, List<@Valid ComparisonToolConfigFilterDto> filters) {
    this.page = page;
  ...
  public ComparisonToolConfigDto page(ComparisonToolConfigPageDto page) {
    this.page = page;
    return this;
  }
  ...
  @JsonProperty("page")
  public ComparisonToolConfigPageDto getPage() {
    return page;
  }

  public void setPage(ComparisonToolConfigPageDto page) {
    this.page = page;
  }
  ...
  public static class Builder {
    ...
    public ComparisonToolConfigDto.Builder page(ComparisonToolConfigPageDto page) {
