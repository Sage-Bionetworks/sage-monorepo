...
public class ComparisonToolConfigFilterDto {
   ...
   */
  @NotNull 
  @Schema(name = "data_key", example = "biodomains", description = "Field to filter on", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "query_param_key", example = "biodomain", description = "Query parameter key for the filter", requiredMode = Schema.RequiredMode.REQUIRED)
