...
@Configuration(
  value = "org.sagebionetworks.agora.api.next.configuration.enumConverterConfiguration"
)
public class EnumConverterConfiguration {

  @Bean(
    name = "org.sagebionetworks.agora.api.next.configuration.EnumConverterConfiguration.comparisonToolConfigPageConverter"
  )
  ...
  @Bean(
    name = "org.sagebionetworks.agora.api.next.configuration.EnumConverterConfiguration.itemFilterTypeQueryConverter"
  )
