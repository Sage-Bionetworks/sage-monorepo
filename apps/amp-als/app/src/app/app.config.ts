...
import { BASE_PATH as API_CLIENT_BASE_PATH } from '@sagebionetworks/amp-als/api-client-angular';
import { configFactory, ConfigService } from '@sagebionetworks/amp-als/config';
...
import {
  ...
  // rollbarFactory,
  // RollbarService,
} from '@sagebionetworks/amp-als/services';
...
export const appConfig: ApplicationConfig = {
  providers: [
    { provide: APP_ID, useValue: 'amp-als-app' },
    {
