...
public interface DatasetApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "A dataset", content = {
                ...
                @Content(mediaType = "application/ld+json", schema = @Schema(implementation = DatasetDto.class)),
    ...
    default ResponseEntity<DatasetDto> getDataset(
        @Parameter(name = "datasetId", description = "The unique identifier of the dataset.", required = true) @PathVariable("datasetId") Long datasetId
    ) {
    ...
    default ResponseEntity<DatasetsPageDto> listDatasets(
        @Parameter(name = "datasetSearchQuery", description = "The search query used to find datasets.") @Valid DatasetSearchQueryDto datasetSearchQuery
    ) {
