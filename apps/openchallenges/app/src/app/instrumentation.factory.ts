...
export const instrumentationFactory = (configService: ConfigService) => {
  return () => {
    console.log(`Instrumentation enabled: ${configService.config.instrumentationEnabled}`);
    if (configService.config.instrumentationEnabled) {
