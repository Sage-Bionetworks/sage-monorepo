...
public class EdamConceptsPageDto {
  ...
  @Valid
  private List<EdamConceptDto> edamConcepts = new ArrayList<>();
  ...
  public EdamConceptsPageDto edamConcepts(List<EdamConceptDto> edamConcepts) {
  ...
  @NotNull
  @Valid
  @Schema(name = "edamConcepts", description = "A list of EDAM concepts.", required = true)
  public List<EdamConceptDto> getEdamConcepts() {
    return edamConcepts;
  }

  public void setEdamConcepts(List<EdamConceptDto> edamConcepts) {
    this.edamConcepts = edamConcepts;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        number, size, totalElements, totalPages, hasNext, hasPrevious, edamConcepts);
  }
