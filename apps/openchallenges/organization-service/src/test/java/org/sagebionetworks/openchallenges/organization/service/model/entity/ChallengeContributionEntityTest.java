...
class ChallengeContributionEntityTest {
    ...
    @Test
    void ChallengeContributionEntityGetters_ShouldReturnChallengeContributionEntityValues_WhenArgsPassedViaSetters() {
    ...
    @Test
    void ChallengeContributionEntityGetters_ShouldReturnChallengeContributionEntityValues_WhenAllArgsPassedtoConstructor() {
    ...
    @Test
    void ChallengeContributionEntityGetters_ShouldReturnArgumentsPassed_WhenOrganizationEntityBuiltWithClassBuilder() {
    ...
    @Test
    void DataMethods_ShouldReturnRecognizeIdenticalAndDifferentChallengeContributionEntity_WhenChallengeContributionEntityCompared() {
