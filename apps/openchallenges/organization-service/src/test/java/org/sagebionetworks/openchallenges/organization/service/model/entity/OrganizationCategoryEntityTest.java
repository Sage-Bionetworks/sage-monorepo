...
class OrganizationCategoryEntityTest {
    ...
    void setup() {
        ...
        contributor3 = OrganizationCategoryEntity.builder()
                .id(entityId2)
    ...
    void getters_ShouldReturnExpectedValues_WhenArgumentsPassed() {
        ...
        Assertions.assertEquals(organization, contributor1.getOrganization(), "Organization should match for contributor1");
        Assertions.assertEquals(category, contributor1.getCategory(), "Category should match for contributor1");
        ...
        Assertions.assertEquals(organization, contributor2.getOrganization(), "Organization should match for contributor2");
        Assertions.assertEquals(category, contributor2.getCategory(), "Category should match for contributor2");
    }
    ...
    void shouldReturnArgumentsPassed_WhenOrganizationCategoryEntityBuiltWithClassBuilder() {
        ...
        Assertions.assertEquals(organization, contributor3.getOrganization(), "Organization should match for contributor3");
        Assertions.assertEquals(category, contributor3.getCategory(), "Category should match for contributor3");
    }
    ...
    void shouldReturnSameOrDifferent_WhenTwoOrganizationCategoryEntityCompared() {
        ...
        Assertions.assertNotEquals(contributor1, contributor3, "Contributors 1 and 3 should not be equal");
    }

    @Test
    void hashCode_ShouldBeTheSameOrDifferent_WhenTwoOrganizationCategoryEntityCompared() {
        // Verify the generated hashCode() method
        Assertions.assertEquals(contributor1.hashCode(), contributor2.hashCode(), "Hash codes of contributors 1 and 2 should match");
        Assertions.assertNotEquals(contributor1.hashCode(), contributor3.hashCode(), "Hash codes of contributors 1 and 3 should not match");
    }
}
