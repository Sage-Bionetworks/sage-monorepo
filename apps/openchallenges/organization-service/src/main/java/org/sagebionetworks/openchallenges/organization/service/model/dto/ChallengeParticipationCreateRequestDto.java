...
@Schema(name = "ChallengeParticipationCreateRequest", description = "A request to create a challenge participation for an organization, defined by a challenge ID and a role. ")
...
public class ChallengeParticipationCreateRequestDto {
   ...
   */
  public ChallengeParticipationCreateRequestDto(Long challengeId, ChallengeParticipationRoleDto role) {
  ...
  public boolean equals(Object o) {
    ...
    ChallengeParticipationCreateRequestDto challengeParticipationCreateRequest = (ChallengeParticipationCreateRequestDto) o;
    return Objects.equals(this.challengeId, challengeParticipationCreateRequest.challengeId) &&
  ...
  */
  public ChallengeParticipationCreateRequestDto.Builder toBuilder() {
    ChallengeParticipationCreateRequestDto.Builder builder = new ChallengeParticipationCreateRequestDto.Builder();
