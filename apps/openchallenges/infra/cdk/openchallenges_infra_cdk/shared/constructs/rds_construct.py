"""PostgreSQL RDS construct for OpenChallenges infrastructure."""
...
class PostgresDatabase(Construct):
    ...
    def __init__(
        ...
        vpc: ec2.IVpc,
        stack_prefix: str,
        database_name: str = "openchallenges",
        ...
        **kwargs,
        ...
        Args:
            ...
            database_name: Name of the default database (default: openchallenges)
