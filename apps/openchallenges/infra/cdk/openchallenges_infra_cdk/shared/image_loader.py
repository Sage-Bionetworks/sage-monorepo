...
def load_container_image(
    ...
    Args:
        ...
        service_name: Service name (e.g., 'openchallenges-challenge-service')
    ...
    Example:
        ...
        ... )
        # Returns ECR URI from /tmp/openchallenges-challenge-service.tar

        >>> # Override for specific service
        >>> os.environ['USE_LOCAL_OPENCHALLENGES_CHALLENGE_SERVICE_IMAGE'] = 'false'
