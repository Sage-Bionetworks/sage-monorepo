...
public class OAuth2WebController {
  ...
  public String oauth2Callback(
    ...
    logger.debug("OAuth2 callback received - code: {}, error: {}, state: {}", 
    ...
    try {
      ...
      String redirectUri = oAuth2ConfigurationService.getRedirectUri(ExternalAccount.Provider.google);
      ...
      logger.debug("Adding tokens to model - accessToken: {}, refreshToken: {}, tokenType: {}, expiresIn: {}", 
