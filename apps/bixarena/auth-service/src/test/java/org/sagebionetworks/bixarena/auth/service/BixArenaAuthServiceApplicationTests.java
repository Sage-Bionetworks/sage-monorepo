...
@SpringBootTest(
  properties = {
    "app.welcome-message=Welcome to BixArena Auth Service (test)",
    ...
    "app.auth.redirect-uri=http://localhost:8115/v1/auth/oidc/callback",
...
@ActiveProfiles("test")
class BixArenaAuthServiceApplicationTests {

  @Autowired
  private BixArenaAuthServiceApplication application;
