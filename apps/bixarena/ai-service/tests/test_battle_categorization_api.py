...
from bixarena_ai_service.models.battle_categorization_request import BattleCategorizationRequest  # noqa: F401
...
def test_categorize_battle(client: TestClient):
    ...
    Categorize a battle
    """
    battle_categorization_request = {"prompts":["prompts","prompts","prompts","prompts","prompts"]}
