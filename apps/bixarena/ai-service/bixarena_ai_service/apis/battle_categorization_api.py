...
from bixarena_ai_service.apis.battle_categorization_api_base import BaseBattleCategorizationApi
...
async def categorize_battle(
    battle_categorization_request: BattleCategorizationRequest = Body(None, description=""),
    ...
    return await BaseBattleCategorizationApi.subclasses[0]().categorize_battle(battle_categorization_request)
