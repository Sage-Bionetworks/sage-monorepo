...
from bixarena_app.fastchat.constants import CPU_ISA
from bixarena_app.fastchat.conversation import Conversation, get_conv_template
from bixarena_app.fastchat.model.compression import load_compress_model
from bixarena_app.fastchat.model.llama_condense_monkey_patch import (
    replace_llama_with_condense,
)
from bixarena_app.fastchat.model.model_chatglm import generate_stream_chatglm
from bixarena_app.fastchat.model.model_codet5p import generate_stream_codet5p
from bixarena_app.fastchat.model.model_falcon import generate_stream_falcon
from bixarena_app.fastchat.model.model_yuan2 import generate_stream_yuan2
from bixarena_app.fastchat.model.model_exllama import generate_stream_exllama
from bixarena_app.fastchat.model.model_xfastertransformer import generate_stream_xft
from bixarena_app.fastchat.model.monkey_patch_non_inplace import (
    replace_llama_attn_with_non_inplace_operations,
)
from bixarena_app.fastchat.modules.awq import AWQConfig, load_awq_quantized
from bixarena_app.fastchat.modules.exllama import ExllamaConfig, load_exllama_model
from bixarena_app.fastchat.modules.xfastertransformer import load_xft_model, XftConfig
from bixarena_app.fastchat.modules.gptq import GptqConfig, load_gptq_quantized
from bixarena_app.fastchat.utils import get_gpu_memory
...
def get_generate_stream_function(model: torch.nn.Module, model_path: str):
    ...
    from bixarena_app.fastchat.serve.inference import generate_stream
...
class RwkvAdapter(BaseModelAdapter):
    ...
    def load_model(self, model_path: str, from_pretrained_kwargs: dict):
        from bixarena_app.fastchat.model.rwkv_model import RwkvModel
