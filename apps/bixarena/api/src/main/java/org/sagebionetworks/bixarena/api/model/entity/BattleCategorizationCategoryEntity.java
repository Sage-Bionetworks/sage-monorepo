...
@Entity
@Table(name = "battle_categorization_category", schema = "api")
@IdClass(BattleCategorizationCategoryEntity.CategoryKey.class)
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BattleCategorizationCategoryEntity {
