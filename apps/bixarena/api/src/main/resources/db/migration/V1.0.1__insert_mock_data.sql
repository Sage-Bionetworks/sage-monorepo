...
INSERT INTO model (id, slug, name, license, organization, description, external_link, api_model_name, api_base, api_type, created_at, updated_at) VALUES
  ('f1111111-1111-1111-1111-111111111111', 'kimi-k2', 'Kimi K2', 'Open Source', 'Moonshot AI', 'Kimi K2 model by Moonshot AI', 'https://openrouter.ai/models/moonshotai/kimi-k2', 'moonshotai/kimi-k2:free', 'https://openrouter.ai/api/v1', 'openai', '2025-09-30 14:30:00+00', '2025-09-30 14:30:00+00'),
  ('f2222222-2222-2222-2222-222222222222', 'deepseek-r1-0528', 'DeepSeek R1 (0528)', 'Open Source', 'DeepSeek', 'DeepSeek R1 model from May 28th', 'https://openrouter.ai/models/deepseek/deepseek-r1-0528', 'deepseek/deepseek-r1-0528:free', 'https://openrouter.ai/api/v1', 'openai', '2025-09-30 14:30:00+00', '2025-09-30 14:30:00+00'),
  ('f3333333-3333-3333-3333-333333333333', 'qwen3-235b-a22b', 'Qwen 3 235B', 'Open Source', 'Alibaba', 'Qwen 3 235B parameter model', 'https://openrouter.ai/models/qwen/qwen3-235b-a22b', 'qwen/qwen3-235b-a22b:free', 'https://openrouter.ai/api/v1', 'openai', '2025-09-30 14:30:00+00', '2025-09-30 14:30:00+00'),
  ('f4444444-4444-4444-4444-444444444444', 'deepseek-chat-v3-0324', 'DeepSeek Chat v3 (0324)', 'Open Source', 'DeepSeek', 'DeepSeek Chat v3 from March 24th', 'https://openrouter.ai/models/deepseek/deepseek-chat-v3-0324', 'deepseek/deepseek-chat-v3-0324:free', 'https://openrouter.ai/api/v1', 'openai', '2025-09-30 14:30:00+00', '2025-09-30 14:30:00+00'),
  ('f5555555-5555-5555-5555-555555555555', 'deepseek-r1', 'DeepSeek R1', 'Open Source', 'DeepSeek', 'DeepSeek R1 latest model', 'https://openrouter.ai/models/deepseek/deepseek-r1', 'deepseek/deepseek-r1:free', 'https://openrouter.ai/api/v1', 'openai', '2025-09-30 14:30:00+00', '2025-09-30 14:30:00+00');
