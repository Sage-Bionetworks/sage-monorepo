"""Resource naming utilities for BixArena infrastructure."""
...
def generate_resource_name(
    ...
    if environment == "dev" and developer_name:
        base_name = f"bixarena-dev-{developer_name}-{resource_type}"
    else:
        base_name = f"bixarena-{environment}-{resource_type}"
