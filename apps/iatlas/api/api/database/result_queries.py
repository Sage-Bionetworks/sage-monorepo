...
accepted_coloc_option_args = ["data_set", "coloc_data_set", "feature", "gene", "snp"]
...
accepted_ggr_query_args = ["dataset_id", "id" "feature_id", "snp_id", "p_value", "maf"]
...
def return_colocalization_query(*args):
    option_args = build_option_args(*args, accepted_args=accepted_coloc_option_args)
...
def return_copy_number_result_query(*args):
    option_args = build_option_args(*args, accepted_args=accepted_cnr_option_args)
    query_args = build_query_args(
...
def return_driver_result_query(*args):
    option_args = build_option_args(*args, accepted_args=accepted_dr_option_args)
    query_args = build_query_args(
...
def return_heritability_result_query(*args):
    option_args = build_option_args(*args, accepted_args=accepted_hr_option_args)
    query_args = build_query_args(
...
def return_germline_gwas_result_query(*args):
    option_args = build_option_args(*args, accepted_args=accepted_ggr_option_args)
    query_args = build_query_args(
...
def return_rare_variant_pathway_associations_query(*args):
    option_args = build_option_args(*args, accepted_args=accepted_rvpa_option_args)
    query_args = build_query_args(
        RareVariantPathwayAssociation, *args, accepted_args=accepted_rvpa_query_args
    )
    query = db.session.query(*query_args)
    if option_args:
        query = db.session.query(RareVariantPathwayAssociation).options(*option_args)
    return query
