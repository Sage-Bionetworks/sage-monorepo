...
from .resolver_helpers.paging_utils import (
    paginate,
    Paging,
    paging_fields,
    create_paging,
...
def resolve_cells(
    _obj, info, distinct=False, paging=None, cohort=None, cell=None, feature=None
):
    ...
    feature_requested = get_requested(
        ...
        requested_field_mapping=cell_related_feature_request_fields,
        child_node="features",
    )
    ...
    res = paginate(
        ...
        distinct,
        build_cell_graphql_response(
            requested=requested, feature_requested=feature_requested
        ),
