...
def resolve_driver_results(
    ...
    maxLog10PValue=None,
    minFoldChange=None,
    minLog10FoldChange=None,
    minLog10PValue=None,
    minPValue=None,
    minNumMutants=None,
    minNumWildTypes=None,
):
    ...
    requested = get_requested(
        ...
        requested_field_mapping=driver_result_request_fields,
    )
    ...
    mutation_type_requested = get_requested(
        ...
        requested_field_mapping=mutation_type_request_fields,
        child_node="mutationType",
    )
    ...
    query, count_query = build_driver_result_request(
        ...
        max_log10_p_value=maxLog10PValue,
        min_fold_change=minFoldChange,
        min_log10_fold_change=minLog10FoldChange,
        min_log10_p_value=minLog10PValue,
        min_p_value=minPValue,
        min_n_mut=minNumMutants,
        min_n_wt=minNumWildTypes,
        mutation=mutation,
