...
edge_request_fields = {"label", "name", "node1", "node2", "score"}
...
def build_edge_request(
    ...
    node_1_core = get_node_column_labels(node_1_requested, node_1, prefix="node1_")
    node_2_core = get_node_column_labels(node_2_requested, node_2, prefix="node2_")
