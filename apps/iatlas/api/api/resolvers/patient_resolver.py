...
def resolve_patients(
    ...
    distinct=False,
    paging=None,
    maxAgeAtDiagnosis=None,
    minAgeAtDiagnosis=None,
    barcode=None,
    dataSet=None,
    ethnicity=None,
    gender=None,
    ...
    slide_requested = get_requested(
        ...
        requested_field_mapping=simple_slide_request_fields,
        child_node="slides",
    )
    ...
    query, count_query = build_patient_request(
        ...
        paging=paging,
        distinct=distinct,
        max_age_at_diagnosis=maxAgeAtDiagnosis,
        min_age_at_diagnosis=minAgeAtDiagnosis,
        barcode=barcode,
        data_set=dataSet,
        ethnicity=ethnicity,
        gender=gender,
    ...
    res = paginate(
        ...
        build_patient_graphql_response(
            requested=requested,
            slide_requested=slide_requested,
            sample=sample,
            slide=slide,
        ),
