...
def resolve_data_sets(
    _obj, info, dataSet=None, sample=None, dataSetType=None, paging=None, distinct=False
):
    ...
    sample_requested = get_requested(
        ...
        requested_field_mapping=simple_sample_request_fields,
        child_node="samples",
    )
