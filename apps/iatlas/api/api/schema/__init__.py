...
cell_query = load_schema_from_path(schema_dirname + "/cell.query.graphql")
cell_stat_query = load_schema_from_path(schema_dirname + "/cellStat.query.graphql")
cohort_query = load_schema_from_path(schema_dirname + "/cohort.query.graphql")
...
data_set_query = load_schema_from_path(schema_dirname + "/dataset.query.graphql")
driver_result_query = load_schema_from_path(
    schema_dirname + "/driverResult.query.graphql"
)
edge_query = load_schema_from_path(schema_dirname + "/edge.query.graphql")
feature_query = load_schema_from_path(schema_dirname + "/feature.query.graphql")
gene_query = load_schema_from_path(schema_dirname + "/gene.query.graphql")
gene_type_query = load_schema_from_path(schema_dirname + "/geneType.query.graphql")
...
mutation_query = load_schema_from_path(schema_dirname + "/mutation.query.graphql")
neoantigen_query = load_schema_from_path(schema_dirname + "/neoantigen.query.graphql")
node_query = load_schema_from_path(schema_dirname + "/node.query.graphql")
patient_query = load_schema_from_path(schema_dirname + "/patient.query.graphql")
publication_query = load_schema_from_path(schema_dirname + "/publication.query.graphql")
...
def serialize_ethnicity_enum(value):
    return (
        value
        if value == "not hispanic or latino" or value == "hispanic or latino"
        else None
    )
...
rare_variant_pathway_association = ObjectType("RareVariantPathwayAssociationNode")
...
root.set_field(
    "rareVariantPathwayAssociations", resolve_rare_variant_pathway_associations
)
