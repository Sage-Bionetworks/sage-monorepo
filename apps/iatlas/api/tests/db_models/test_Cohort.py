...
def test_tag_cohort_no_relationships(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related_id3, data_set_id
):
...
def test_dataset_cohort_no_relationships(
    app, pcawg_cohort_name, pcawg_cohort_id, pcawg_data_set_id
):
    query = return_cohort_query()
...
def test_cohort_samples_relationship(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related_id3, data_set_id
):
...
def test_cohort_genes_relationship(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related_id3, data_set_id
):
...
def test_cohort_features_relationship(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related_id3, data_set_id
):
...
def test_cohort_mutations_relationship(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related_id3, data_set_id
):
...
def test_cohort_tag_relationship(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related3, related_id3, data_set_id
):
...
def test_cohort_dataset_relationship(
    app, tcga_tag_cohort_name, tcga_tag_cohort_id, related_id3, data_set_id, data_set
):
