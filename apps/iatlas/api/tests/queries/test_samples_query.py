...
def test_samples_query_with_passed_maxAgeAtDiagnosis(
    client, common_query, max_age_at_diagnosis
):
    response = client.post(
        "/api",
        json={
            "query": common_query,
            "variables": {"maxAgeAtDiagnosis": max_age_at_diagnosis},
        },
    )
    json_data = json.loads(response.data)
    page = json_data["data"]["samples"]
...
def test_samples_query_with_passed_minAgeAtDiagnosis(
    client, common_query, min_age_at_diagnosis
):
    response = client.post(
        "/api",
        json={
            "query": common_query,
            "variables": {"minAgeAtDiagnosis": min_age_at_diagnosis},
        },
    )
    json_data = json.loads(response.data)
    page = json_data["data"]["samples"]
...
def test_samples_query_with_patient_and_sample(client, common_query, patient, sample):
    response = client.post(
        ...
        json={
            "query": common_query,
            "variables": {"patient": [patient], "sample": [sample]},
        },
    )
    json_data = json.loads(response.data)
    page = json_data["data"]["samples"]
