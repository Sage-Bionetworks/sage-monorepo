...
def test_rareVariantPathwayAssociation_cursor_pagination_first(
    client, common_query_builder
):
...
def test_rareVariantPathwayAssociation_cursor_pagination_last(
    client, common_query_builder
):
    query = common_query_builder(
        """{
...
def test_rareVariantPathwayAssociation_query_with_passed_min_p_value(
    client, common_query, data_set, rvpa_min_p_value
):
    response = client.post(
        "/api",
        json={
            "query": common_query,
            "variables": {"dataSet": [data_set], "minPValue": rvpa_min_p_value},
        },
    )
    json_data = json.loads(response.data)
    page = json_data["data"]["rareVariantPathwayAssociations"]
...
def test_rareVariantPathwayAssociation_query_with_passed_max_p_value(
    client, common_query, data_set, rvpa_max_p_value
):
    response = client.post(
        "/api",
        json={
            "query": common_query,
            "variables": {"dataSet": [data_set], "maxPValue": rvpa_max_p_value},
        },
    )
    json_data = json.loads(response.data)
    page = json_data["data"]["rareVariantPathwayAssociations"]
...
def test_rareVariantPathwayAssociation_query_with_no_arguments_no_relations(
    client, common_query_builder
):
    query = common_query_builder(
        """{
