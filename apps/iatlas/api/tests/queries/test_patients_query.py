...
def test_patients_query_with_passed_slide_and_maxAgeAtDiagnosis(
    client, full_query, slide, max_age_at_diagnosis
):
    ...
    response = client.post(
        ...
        json={
            "query": full_query,
            "variables": {"maxAgeAtDiagnosis": max_age_at_diagnosis, "slide": [slide]},
        },
    )
    json_data = json.loads(response.data)
    results = json_data["data"]["patients"]["items"]
...
def test_patients_query_with_passed_slide_and_minAgeAtDiagnosis(
    client, full_query, slide, min_age_at_diagnosis
):
    response = client.post(
        "/api",
        json={
            "query": full_query,
            "variables": {"minAgeAtDiagnosis": min_age_at_diagnosis, "slide": [slide]},
        },
    )
    json_data = json.loads(response.data)
    results = json_data["data"]["patients"]["items"]
