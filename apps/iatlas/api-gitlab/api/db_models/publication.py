...
class Publication(Base):
    ...
    genes = db.relationship(
        'Gene', secondary='publications_to_genes_to_gene_sets', uselist=True, lazy='noload')

    gene_sets = db.relationship(
        'GeneSet', secondary='publications_to_genes_to_gene_sets', uselist=True, lazy='noload')
