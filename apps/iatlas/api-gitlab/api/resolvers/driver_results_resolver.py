...
def resolve_driver_results(
        _obj, info, dataSet=None, distinct=False, entrez=None, feature=None, maxPValue=None, maxLog10PValue=None, minFoldChange=None, minLog10FoldChange=None, minLog10PValue=None, minPValue=None, minNumMutants=None, minNumWildTypes=None, mutationCode=None, paging=None, related=None, tag=None):
