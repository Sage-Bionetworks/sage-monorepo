...
def resolve_samples_by_mutations_status(_obj, info, ageAtDiagnosis=None, ethnicity=None, gender=None, height=None, mutationId=None,
                                        mutationStatus=None, patient=None, race=None, sample=None, weight=None):
