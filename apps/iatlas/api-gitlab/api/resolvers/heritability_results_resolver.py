...
def resolve_heritability_results(
        _obj, info, dataSet=None, distinct=False, feature=None, maxPValue=None, minFoldChange=None, minPValue=None, paging=None, cluster=None):
    ...
    query, count_query = build_heritability_result_request(
        requested, data_set_requested, feature_requested, data_set=dataSet, distinct=distinct, feature=feature, max_p_value=maxPValue, min_p_value=minPValue, cluster=cluster, paging=paging)
