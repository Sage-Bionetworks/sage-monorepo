...
def resolve_edges(_obj, info, dataSet=None, related=None, network=None, page=1):
    ...
    node_2_selection_set = get_selection_set(
        selection_set, 'node2' in requested, 'node2')
