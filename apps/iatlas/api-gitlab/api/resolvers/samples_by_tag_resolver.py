...
def resolve_samples_by_tag(_obj, info, ageAtDiagnosis=None, dataSet=None, ethnicity=None, feature=None, featureClass=None, gender=None, height=None,
                           name=None, patient=None, race=None, related=None, tag=None, weight=None):
