...
def get_requested(info, requested_field_mapping, condition=False, child_node=None):
    selection_set = get_selection_set(
        info.field_nodes[0].selection_set, condition, child_node=child_node) if info else []
