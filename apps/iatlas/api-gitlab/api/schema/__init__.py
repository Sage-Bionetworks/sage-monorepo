...
from api.resolvers import (
    ...
    resolve_features_by_class, resolve_features_by_tag, resolve_gene, resolve_gene_family, resolve_gene_types,
...
type_defs = [root_query, copy_number_result_query, data_set_query, driver_result_query, feature_query,
             gene_query, gene_family_query, gene_type_query, mutation_query, mutation_code_query, patient_query,
...
schema = make_executable_schema(
    ...
    [root, copy_number_result, data_set, direction_enum_scalar, driver_result, feature,
     features_by_class, features_by_tag, feature_value_scalar, gene, gene_family, genes_by_tag, gene_type,
