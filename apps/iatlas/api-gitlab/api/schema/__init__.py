...
type_defs = [root_query, relay_base_query, copy_number_result_query, data_set_query, driver_result_query, edge_query, feature_query,
...
schema = make_executable_schema(
    type_defs,
    [root, copy_number_result, data_set, direction_enum_scalar, driver_result, driver_result_page,
