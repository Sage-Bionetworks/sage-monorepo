...
from flaskr.resolvers import (
    resolve_gene, resolve_genes, resolve_tags, resolve_test, resolve_mutation)
...
type_defs = [root_query, tag_query, gene_query, mutation_query]
...
schema = make_executable_schema(
    type_defs, [root, gene, tag, mutation])
