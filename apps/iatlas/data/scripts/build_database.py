...
from schematic_db.manifest_store.synapse_manifest_store import (
    SynapseManifestStore, ManifestStoreConfig
)
...
cohorts_to_samples1['id'] = [uuid.uuid1() for _ in range(len(cohorts_to_samples1.index))]
...
cohorts_to_samples2['id'] = [uuid.uuid1() for _ in range(len(cohorts_to_samples2.index))]
...
cohorts_to_features['id'] = [uuid.uuid1() for _ in range(len(cohorts_to_features.index))]
...
cohorts_to_mutations['id'] = [uuid.uuid1() for _ in range(len(cohorts_to_mutations.index))]
